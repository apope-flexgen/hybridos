...
// DEPRECATED -- returns size, count, err
// func (disk *DiskCollector) getSizeAndCount(path string) (float64, int, error) {
// 	var size int64
// 	var count int
...
// 	return math.Round(float64(size)/1000000*10) / 10, count, err
// }
