...
$fimsSend /ess/controls/ess/bms_1/BatteryBalancingStartCmd false
...
$fimsSend /ess/controls/ess/bms_1/BatteryBalancingStartCmd true
sleep 1
# echo -n "Current state is now " && $fimsGet /ess/control/new_config_brb_bms_1/BatteryBalancing/StateVariable
...
for ((i=1; i<=$numRacks; i++))
    do 
    $fimsSend /ess/status/bms_1_rack_$i/contactorStatus false
    done
...
read -n 1 -s
$fimsSend /ess/status/bms_1_rack_1/enableFeedback false
echo
