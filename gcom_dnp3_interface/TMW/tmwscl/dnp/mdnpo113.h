 ...
 *   DNP Master functionality for Object 113 Virtual Terminal Events.
 */
#ifndef MDNPO113_DEFINED
#define MDNPO113_DEFINED
...
extern "C" {
   ...
   * purpose: Process read response for object 113 all variations
   * arguments:
