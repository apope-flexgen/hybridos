 ...
 *   DNP Master functionality for Object 33 Frozen Analog Input Events.
 */
#ifndef MDNPO033_DEFINED
#define MDNPO033_DEFINED
...
extern "C" {
   ...
   * purpose: Process read response for object 33 any variation
   * arguments:
