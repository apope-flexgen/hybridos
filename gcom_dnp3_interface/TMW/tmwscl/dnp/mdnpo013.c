...
/* file: mdnpo013.c
 * description: DNP Master functionality for Object 13 Binary Output Command Events
 */
...
static TMWTYPES_BOOL TMWDEFS_LOCAL _dbStoreFunc(
  TMWDB_DATA *pData)
{
  MDNPO013_DATA *pDNPData = (MDNPO013_DATA *)pData;
  ...
  TMWDTIME *pTimeStamp)
{
  ...
  MDNPO013_DATA *pDNPData = (MDNPO013_DATA *)tmwtarg_alloc(sizeof(MDNPO013_DATA));
...
static void TMWDEFS_LOCAL _storeBinaryOutputCmdStatus(
  ...
  TMWDTIME *pTimeStamp)
{ 
  mdnpdata_storeBinaryCmdStatus(pDbHandle, pointNumber, value, TMWDEFS_TRUE, pTimeStamp);
}
#endif /* TMWCNFG_SUPPORT_ASYNCH_DB */
#endif /* MDNPDATA_SUPPORT_OBJ13 */

#if MDNPDATA_SUPPORT_OBJ13_V1
/* file: mdnpo013_readObj13v1 */
TMWTYPES_BOOL TMWDEFS_GLOBAL mdnpo013_readObj13v1(
  TMWSESN *pSession,
  ...
  DNPUTIL_OBJECT_HEADER *pObjHeader)
{
  ...
  for(i = 0; i < pObjHeader->numberOfPoints; i++)
  {
    ...
    DNPDIAG_SHOW_BINARY_CMD_STATUS(pSession, pointNumber, flags, TMWDEFS_NULL);

    _storeBinaryOutputCmdStatus(pMDNPSession->pDbHandle, 
      pointNumber, flags, TMWDEFS_NULL);
  }

  return(TMWDEFS_TRUE);
}
#endif /* MDNPDATA_SUPPORT_OBJ13_V1 */

#if MDNPDATA_SUPPORT_OBJ13_V2
/* file: mdnpo013_readObj13v2 */
TMWTYPES_BOOL TMWDEFS_GLOBAL mdnpo013_readObj13v2(
  TMWSESN *pSession,
  DNPUTIL_RX_MSG *pRxFragment,
  DNPUTIL_OBJECT_HEADER *pObjHeader)
{
  ...
  for(i = 0; i < pObjHeader->numberOfPoints; i++)
  {
    ...
    DNPDIAG_SHOW_BINARY_CMD_STATUS(pSession, pointNumber, flags, &timeStamp);
...
#endif /* MDNPDATA_SUPPORT_OBJ13_V2 */
