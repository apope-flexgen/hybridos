...
/* file: mdnpo023.c
 * description: DNP Master functionality for Object 23 Frozen Counter Events
 */
...
typedef struct MDNPO023DataStruct {
  TMWDB_DATA tmw;
...
static TMWTYPES_BOOL TMWDEFS_LOCAL _dbStoreFunc(
  TMWDB_DATA *pData)
{
  MDNPO023_DATA *pDNPData = (MDNPO023_DATA *)pData;
  ...
  TMWDTIME *pTimeStamp)
{
  ...
  MDNPO023_DATA *pDNPData = (MDNPO023_DATA *)tmwtarg_alloc(sizeof(MDNPO023_DATA));
...
#endif /* MDNPDATA_SUPPORT_OBJ23 */

#if MDNPDATA_SUPPORT_OBJ23_V1
/* function: mdnpo023_readObj23v1 */
TMWTYPES_BOOL TMWDEFS_GLOBAL mdnpo023_readObj23v1(
  TMWSESN *pSession,
  ...
  DNPUTIL_OBJECT_HEADER *pObjHeader)
{
  ...
  for(i = 0; i < pObjHeader->numberOfPoints; i++)
  {
    ...
    DNPDIAG_SHOW_FROZEN_COUNTER(pSession, pointNumber, value, flags, TMWDEFS_TRUE, TMWDEFS_NULL);
...
#endif /* MDNPDATA_SUPPORT_OBJ23_V1 */

#if MDNPDATA_SUPPORT_OBJ23_V2
/* function: mdnpo023_readObj23v2 */
TMWTYPES_BOOL TMWDEFS_GLOBAL mdnpo023_readObj23v2(
  TMWSESN *pSession,
  DNPUTIL_RX_MSG *pRxFragment,
  DNPUTIL_OBJECT_HEADER *pObjHeader)
{
...
#endif /* MDNPDATA_SUPPORT_OBJ23_V2 */

#if MDNPDATA_SUPPORT_OBJ23_V5
/* function: mdnpo023_readObj23v5 */
TMWTYPES_BOOL TMWDEFS_GLOBAL mdnpo023_readObj23v5(
  TMWSESN *pSession,
  DNPUTIL_RX_MSG *pRxFragment,
  DNPUTIL_OBJECT_HEADER *pObjHeader)
{
  ...
  for(i = 0; i < pObjHeader->numberOfPoints; i++)
  {
    ...
    DNPDIAG_SHOW_FROZEN_COUNTER(pSession, pointNumber, value, flags, TMWDEFS_TRUE, &dateTime);
...
#endif /* MDNPDATA_SUPPORT_OBJ23_V5 */

#if MDNPDATA_SUPPORT_OBJ23_V6
/* function: mdnpo023_readObj23v6 */
TMWTYPES_BOOL TMWDEFS_GLOBAL mdnpo023_readObj23v6(
  TMWSESN *pSession,
  DNPUTIL_RX_MSG *pRxFragment,
  DNPUTIL_OBJECT_HEADER *pObjHeader)
{
...
#endif /* MDNPDATA_SUPPORT_OBJ23_V6 */

#if MDNPDATA_SUPPORT_OBJ23
/* function: mdnpo023_readObj23 */
TMWTYPES_BOOL TMWDEFS_GLOBAL mdnpo023_readObj23(
  TMWSESN *pSession,
  DNPUTIL_RX_MSG *pRxFragment,
  DNPUTIL_OBJECT_HEADER *pObjHeader)
{
...
#if MDNPDATA_SUPPORT_OBJ23_V1
    case 1:
      status = mdnpo023_readObj23v1(pSession, pRxFragment, pObjHeader);
      break;
#endif
#if MDNPDATA_SUPPORT_OBJ23_V2
    case 2:
      status = mdnpo023_readObj23v2(pSession, pRxFragment, pObjHeader);
      break;
#endif
#if MDNPDATA_SUPPORT_OBJ23_V5
    case 5:
      status = mdnpo023_readObj23v5(pSession, pRxFragment, pObjHeader);
      break;
#endif
#if MDNPDATA_SUPPORT_OBJ23_V6
    case 6:
      status = mdnpo023_readObj23v6(pSession, pRxFragment, pObjHeader);
      break;
#endif
  }
  return(status);
