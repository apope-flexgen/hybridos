 ...
 *   DNP Master functionality for Object 111 String Events.
 */
#ifndef MDNPO111_DEFINED
#define MDNPO111_DEFINED
...
extern "C" {
   ...
   * purpose: Process read response for object 111 all variations
   * arguments:
