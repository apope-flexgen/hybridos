 ...
 *   DNP Master functionality for Object 11 Binary Output Events.
 */
#ifndef MDNPO011_DEFINED
#define MDNPO011_DEFINED
...
extern "C" {
  ...
  /* function: mdnpo011_readObj11v1
   * purpose: Process read response for object 11 variation 1
   * arguments:
  ...
  /* function: mdnpo011_readObj11v2
   * purpose: Process read response for object 11 variation 2
   * arguments:
   *  pSession - identifies session
   *  pRxFragment - received fragment
   *  pObjHeader - object header for current data object
