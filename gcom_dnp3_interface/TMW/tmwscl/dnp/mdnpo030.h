 ...
 *   DNP Master functionality for Object 1 Analog Inputs.
 */
#ifndef MDNPO030_DEFINED
#define MDNPO030_DEFINED
...
extern "C" {
   ...
   * purpose: Process read response for object 30 any variation
   * arguments:
