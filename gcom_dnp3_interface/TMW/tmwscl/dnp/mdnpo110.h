 ...
 *   DNP Master functionality for Object 110 String Data.
 */
#ifndef MDNPO110_DEFINED
#define MDNPO110_DEFINED
...
extern "C" {
   ...
   * purpose: Process read response for object 110 all variations
   * arguments:
