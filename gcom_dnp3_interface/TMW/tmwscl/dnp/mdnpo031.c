...
/* file: mdnpo031.c
 * description: DNP Master functionality for Object 31 Frozen Analog Inputs
 */
...
typedef struct MDNPO031DataStruct {
  TMWDB_DATA tmw;
...
static TMWTYPES_BOOL TMWDEFS_LOCAL _dbStoreFunc(
  TMWDB_DATA *pData)
{
  MDNPO031_DATA *pDNPData = (MDNPO031_DATA *)pData;
  ...
  TMWDTIME *pTimeStamp)
{
  ...
  MDNPO031_DATA *pDNPData = (MDNPO031_DATA *)tmwtarg_alloc(sizeof(MDNPO031_DATA));
  ...
  TMWDTIME *pTimeStamp)
{
  mdnpdata_storeFrozenAnalogInput(pDbHandle, pointNumber, 
    pValue, flags, TMWDEFS_FALSE, pTimeStamp);
}
#endif /* TMWCNFG_SUPPORT_ASYNCH_DB */
#endif /* MDNPDATA_SUPPORT_OBJ31 */

#if MDNPDATA_SUPPORT_OBJ31_V1
/* function: mdnpo031_readObj31v1 */
TMWTYPES_BOOL TMWDEFS_GLOBAL mdnpo031_readObj31v1(
  TMWSESN *pSession,
...
#endif /* MDNPDATA_SUPPORT_OBJ31_V1 */

#if MDNPDATA_SUPPORT_OBJ31_V2
/* function: mdnpo031_readObj31v2 */
TMWTYPES_BOOL TMWDEFS_GLOBAL mdnpo031_readObj31v2(
  TMWSESN *pSession,
  DNPUTIL_RX_MSG *pRxFragment,
  DNPUTIL_OBJECT_HEADER *pObjHeader)
{
...
#endif /* MDNPDATA_SUPPORT_OBJ31_V2 */

#if MDNPDATA_SUPPORT_OBJ31_V3
/* function: mdnpo031_readObj31v3 */
TMWTYPES_BOOL TMWDEFS_GLOBAL mdnpo031_readObj31v3(
  TMWSESN *pSession,
  DNPUTIL_RX_MSG *pRxFragment,
  DNPUTIL_OBJECT_HEADER *pObjHeader)
{
...
#endif /* MDNPDATA_SUPPORT_OBJ31_V3 */

#if MDNPDATA_SUPPORT_OBJ31_V4
/* function: mdnpo031_readObj31v4 */
TMWTYPES_BOOL TMWDEFS_GLOBAL mdnpo031_readObj31v4(
  TMWSESN *pSession,
  DNPUTIL_RX_MSG *pRxFragment,
  DNPUTIL_OBJECT_HEADER *pObjHeader)
{
...
#endif /* MDNPDATA_SUPPORT_OBJ31_V4 */

#if MDNPDATA_SUPPORT_OBJ31_V5
/* function: mdnpo031_readObj31v5 */
TMWTYPES_BOOL TMWDEFS_GLOBAL mdnpo031_readObj31v5(
  TMWSESN *pSession,
  DNPUTIL_RX_MSG *pRxFragment,
  DNPUTIL_OBJECT_HEADER *pObjHeader)
{
  ...
  for(index = 0; index < pObjHeader->numberOfPoints; index++)
  {
    ...
    DNPDIAG_SHOW_FROZEN_ANALOG(pSession, pointNumber, &anlgValue, 0x01, TMWDEFS_FALSE, TMWDEFS_NULL);
    _storeFrozenAnalogInput(pMDNPSession->pDbHandle, pointNumber, &anlgValue, 0x01, TMWDEFS_NULL);
  }

  return(TMWDEFS_TRUE);
}
#endif /* MDNPDATA_SUPPORT_OBJ31_V5 */

#if MDNPDATA_SUPPORT_OBJ31_V6
/* function: mdnpo031_readObj31v6 */
TMWTYPES_BOOL TMWDEFS_GLOBAL mdnpo031_readObj31v6(
  TMWSESN *pSession,
  DNPUTIL_RX_MSG *pRxFragment,
  DNPUTIL_OBJECT_HEADER *pObjHeader)
{
...
#endif /* MDNPDATA_SUPPORT_OBJ31_V6 */

#if MDNPDATA_SUPPORT_OBJ31_V7
/* function: mdnpo031_readObj31v7 */
TMWTYPES_BOOL TMWDEFS_GLOBAL mdnpo031_readObj31v7(
  TMWSESN *pSession,
  DNPUTIL_RX_MSG *pRxFragment,
  DNPUTIL_OBJECT_HEADER *pObjHeader)
{
...
#endif /* MDNPDATA_SUPPORT_OBJ31_V7 */

#if MDNPDATA_SUPPORT_OBJ31_V8
/* function: mdnpo031_readObj31v8 */
TMWTYPES_BOOL TMWDEFS_GLOBAL mdnpo031_readObj31v8(
  TMWSESN *pSession,
  DNPUTIL_RX_MSG *pRxFragment,
  DNPUTIL_OBJECT_HEADER *pObjHeader)
{
...
#endif /* MDNPDATA_SUPPORT_OBJ31_V8 */

#if MDNPDATA_SUPPORT_OBJ31
/* function: mdnpo031_readObj31 */
TMWTYPES_BOOL TMWDEFS_GLOBAL mdnpo031_readObj31(
  TMWSESN *pSession,
  DNPUTIL_RX_MSG *pRxFragment,
  DNPUTIL_OBJECT_HEADER *pObjHeader)
{
...
#if MDNPDATA_SUPPORT_OBJ31_V1
    case 1:
      status = mdnpo031_readObj31v1(pSession, pRxFragment, pObjHeader);
      break;
#endif
#if MDNPDATA_SUPPORT_OBJ31_V2
    case 2:
      status = mdnpo031_readObj31v2(pSession, pRxFragment, pObjHeader);
      break;
#endif
#if MDNPDATA_SUPPORT_OBJ31_V3
    case 3:
      status = mdnpo031_readObj31v3(pSession, pRxFragment, pObjHeader);
      break;
#endif
#if MDNPDATA_SUPPORT_OBJ31_V4
    case 4:
      status = mdnpo031_readObj31v4(pSession, pRxFragment, pObjHeader);
      break;
#endif
#if MDNPDATA_SUPPORT_OBJ31_V5
    case 5:
      status = mdnpo031_readObj31v5(pSession, pRxFragment, pObjHeader);
      break;
#endif
#if MDNPDATA_SUPPORT_OBJ31_V6
    case 6:
      status = mdnpo031_readObj31v6(pSession, pRxFragment, pObjHeader);
      break;
#endif
#if MDNPDATA_SUPPORT_OBJ31_V7
    case 7:
      status = mdnpo031_readObj31v7(pSession, pRxFragment, pObjHeader);
      break;
#endif
#if MDNPDATA_SUPPORT_OBJ31_V8
    case 8:
      status = mdnpo031_readObj31v8(pSession, pRxFragment, pObjHeader);
      break;
#endif
  }
  return(status);
