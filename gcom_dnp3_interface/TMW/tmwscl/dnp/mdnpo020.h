 ...
 *   DNP Master functionality for Object 20 Binary Counters.
 */
#ifndef MDNPO020_DEFINED
#define MDNPO020_DEFINED
...
extern "C" {
   ...
   * purpose: Process read response for object 20 any variation
   * arguments:
