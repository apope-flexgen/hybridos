 ...
 *   DNP Master functionality for Internal Indication IIN bits
 */
#ifndef MDNPO080_DEFINED
#define MDNPO080_DEFINED
...
extern "C" {
   ...
   * purpose: Process read response for object 80 variation 1
   * arguments:
