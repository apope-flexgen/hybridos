 ...
 *   DNP Master functionality for Object 70 File Transfer
 */
#ifndef MDNPO070_DEFINED
#define MDNPO070_DEFINED
...
extern "C" {
   ...
   * purpose: Process response for object 70 varation 2
   * arguments:
   ...
   * purpose: Process response for object 70 varation 4
   * arguments:
   *  pSession - identifies session
   *  pRxFragment - received fragment
   *  pObjHeader - object header for current data object
   ...
   * purpose: Process response for object 70 varation 5
   * arguments:
   *  pSession - identifies session
   *  pRxFragment - received fragment
   *  pObjHeader - object header for current data object
   ...
   * purpose: Process response for object 70 varation 6
   * arguments:
   *  pSession - identifies session
   *  pRxFragment - received fragment
   *  pObjHeader - object header for current data object
   ...
   * purpose: Process response for object 70 varation 7
   * arguments:
   *  pSession - identifies session
   *  pRxFragment - received fragment
   *  pObjHeader - object header for current data object
