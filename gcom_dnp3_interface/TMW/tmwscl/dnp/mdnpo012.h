 ...
 *   DNP Master functionality for Object 12 Control Block
 */
#ifndef MDNPO012_DEFINED
#define MDNPO012_DEFINED
...
extern "C" {
   ...
   * purpose: Process select or operate response for object 12 
   *   variation 1 or varation 2
   * arguments:
