 ...
 *   DNP Master functionality for Object 1 Binary Inputs.
 */
#ifndef MDNPO001_DEFINED
#define MDNPO001_DEFINED
...
extern "C" {
   ...
   * purpose: Process read response for object 1 variation 1
   * arguments:
   ...
   * purpose: Process read response for object 1 variation 2
   * arguments:
   *  pSession - identifies session
   *  pRxFragment - received fragment
   *  pObjHeader - object header for current data object
