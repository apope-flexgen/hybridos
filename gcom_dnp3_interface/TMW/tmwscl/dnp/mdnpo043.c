...
/* file: mdnpo043.c
 * description: DNP Master functionality for Object 43 Analog Output Command Events
 */
...
typedef struct MDNPO043DataStruct {
  TMWDB_DATA tmw;
...
static TMWTYPES_BOOL TMWDEFS_LOCAL _dbStoreFunc(
  TMWDB_DATA *pData)
{
  MDNPO043_DATA *pDNPData = (MDNPO043_DATA *)pData;
  ...
  TMWDTIME *pTimeStamp)
{
  ...
  MDNPO043_DATA *pDNPData = (MDNPO043_DATA *)tmwtarg_alloc(sizeof(MDNPO043_DATA));
  ...
  TMWDTIME *pTimeStamp)
{
  mdnpdata_storeAnalogCmdStatus(pDbHandle, pointNumber, 
    pValue, status, TMWDEFS_TRUE, pTimeStamp);
}
#endif /* TMWCNFG_SUPPORT_ASYNCH_DB */
#endif /* MDNPDATA_SUPPORT_OBJ43 */

#if MDNPDATA_SUPPORT_OBJ43_V1
/* function: mdnpo043_readObj43v1 */
TMWTYPES_BOOL TMWDEFS_GLOBAL mdnpo043_readObj43v1(
  TMWSESN *pSession,
  ...
  DNPUTIL_OBJECT_HEADER *pObjHeader)
{
  ...
  for(i = 0; i < pObjHeader->numberOfPoints; i++)
  {
    ...
    DNPDIAG_SHOW_ANALOG_CONTROL(pSession, pointNumber, &anlgValue, status, TMWDEFS_TRUE, TMWDIAG_ID_RX, TMWDEFS_NULL);
    _storeAnalogOutputCmdStatus(pMDNPSession->pDbHandle, pointNumber, &anlgValue, status, TMWDEFS_NULL);
  }

  return(TMWDEFS_TRUE);
}
#endif /* MDNPDATA_SUPPORT_OBJ43_V1 */

#if MDNPDATA_SUPPORT_OBJ43_V2
/* function: mdnpo043_readObj43v2 */
TMWTYPES_BOOL TMWDEFS_GLOBAL mdnpo043_readObj43v2(
  TMWSESN *pSession,
  DNPUTIL_RX_MSG *pRxFragment,
  DNPUTIL_OBJECT_HEADER *pObjHeader)
{
...
#endif /* MDNPDATA_SUPPORT_OBJ43_V2 */

#if MDNPDATA_SUPPORT_OBJ43_V3
/* function: mdnpo043_readObj43v3 */
TMWTYPES_BOOL TMWDEFS_GLOBAL mdnpo043_readObj43v3(
  TMWSESN *pSession,
  DNPUTIL_RX_MSG *pRxFragment,
  DNPUTIL_OBJECT_HEADER *pObjHeader)
{
  ...
  for(i = 0; i < pObjHeader->numberOfPoints; i++)
  {
    ...
    DNPDIAG_SHOW_ANALOG_CONTROL(pSession, pointNumber, &anlgValue, status, TMWDEFS_TRUE, TMWDIAG_ID_RX, &dateTime);
    _storeAnalogOutputCmdStatus(pMDNPSession->pDbHandle, pointNumber, &anlgValue, status, &dateTime);
  }

  return(TMWDEFS_TRUE);
}
#endif /* MDNPDATA_SUPPORT_OBJ43_V3 */

#if MDNPDATA_SUPPORT_OBJ43_V4
/* function: mdnpo043_readObj43v4 */
TMWTYPES_BOOL TMWDEFS_GLOBAL mdnpo043_readObj43v4(
  TMWSESN *pSession,
  DNPUTIL_RX_MSG *pRxFragment,
  DNPUTIL_OBJECT_HEADER *pObjHeader)
{
...
#endif /* MDNPDATA_SUPPORT_OBJ43_V4 */

#if MDNPDATA_SUPPORT_OBJ43_V5
/* function: mdnpo043_readObj43v5 */
TMWTYPES_BOOL TMWDEFS_GLOBAL mdnpo043_readObj43v5(
  TMWSESN *pSession,
  DNPUTIL_RX_MSG *pRxFragment,
  DNPUTIL_OBJECT_HEADER *pObjHeader)
{
...
#endif /* MDNPDATA_SUPPORT_OBJ43_V5 */

#if MDNPDATA_SUPPORT_OBJ43_V6
/* function: mdnpo043_readObj43v6 */
TMWTYPES_BOOL TMWDEFS_GLOBAL mdnpo043_readObj43v6(
  TMWSESN *pSession,
  DNPUTIL_RX_MSG *pRxFragment,
  DNPUTIL_OBJECT_HEADER *pObjHeader)
{
...
#endif /* MDNPDATA_SUPPORT_OBJ43_V6 */

#if MDNPDATA_SUPPORT_OBJ43_V7
/* function: mdnpo043_readObj43v7 */
TMWTYPES_BOOL TMWDEFS_GLOBAL mdnpo043_readObj43v7(
  TMWSESN *pSession,
  DNPUTIL_RX_MSG *pRxFragment,
  DNPUTIL_OBJECT_HEADER *pObjHeader)
{
...
#endif /* MDNPDATA_SUPPORT_OBJ43_V7 */

#if MDNPDATA_SUPPORT_OBJ43_V8
/* function: mdnpo043_readObj43v8 */
TMWTYPES_BOOL TMWDEFS_GLOBAL mdnpo043_readObj43v8(
  TMWSESN *pSession,
  DNPUTIL_RX_MSG *pRxFragment,
  DNPUTIL_OBJECT_HEADER *pObjHeader)
{
...
#endif /* MDNPDATA_SUPPORT_OBJ43_V8 */
...
#if MDNPDATA_SUPPORT_OBJ43_V1
    case 1:
      status = mdnpo043_readObj43v1(pSession, pRxFragment, pObjHeader);
      break;
#endif
#if MDNPDATA_SUPPORT_OBJ43_V2
    case 2:
      status = mdnpo043_readObj43v2(pSession, pRxFragment, pObjHeader);
      break;
#endif
#if MDNPDATA_SUPPORT_OBJ43_V3
    case 3:
      status = mdnpo043_readObj43v3(pSession, pRxFragment, pObjHeader);
      break;
#endif
#if MDNPDATA_SUPPORT_OBJ43_V4
    case 4:
      status = mdnpo043_readObj43v4(pSession, pRxFragment, pObjHeader);
      break;
#endif
#if MDNPDATA_SUPPORT_OBJ43_V5
    case 5:
      status = mdnpo043_readObj43v5(pSession, pRxFragment, pObjHeader);
      break;
#endif
#if MDNPDATA_SUPPORT_OBJ43_V6
    case 6:
      status = mdnpo043_readObj43v6(pSession, pRxFragment, pObjHeader);
      break;
#endif
#if MDNPDATA_SUPPORT_OBJ43_V7
    case 7:
      status = mdnpo043_readObj43v7(pSession, pRxFragment, pObjHeader);
      break;
#endif
#if MDNPDATA_SUPPORT_OBJ43_V8
    case 8:
      status = mdnpo043_readObj43v8(pSession, pRxFragment, pObjHeader);
      break;
#endif
  }
  return(status);
