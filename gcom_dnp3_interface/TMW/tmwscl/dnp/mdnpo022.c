...
/* file: mdnpo022.c
 * description: DNP Master functionality for Object 22 Binary Counter Events
 */
...
typedef struct MDNPO022DataStruct {
  TMWDB_DATA tmw;
...
static TMWTYPES_BOOL TMWDEFS_LOCAL _dbStoreFunc(
  TMWDB_DATA *pData)
{
  MDNPO022_DATA *pDNPData = (MDNPO022_DATA *)pData;
  ...
  TMWDTIME *pTimeStamp)
{
  ...
  MDNPO022_DATA *pDNPData = (MDNPO022_DATA *)tmwtarg_alloc(sizeof(MDNPO022_DATA));
  ...
  TMWDTIME *pTimeStamp)
{
  mdnpdata_storeBinaryCounter(pDbHandle, pointNumber, 
    value, flags, TMWDEFS_TRUE, pTimeStamp);
}
#endif /* TMWCNFG_SUPPORT_ASYNCH_DB */
#endif /* MDNPDATA_SUPPORT_OBJ22 */

#if MDNPDATA_SUPPORT_OBJ22_V1
/* function: mdnpo022_readObj22v1 */
TMWTYPES_BOOL TMWDEFS_GLOBAL mdnpo022_readObj22v1(
  TMWSESN *pSession,
  ...
  DNPUTIL_OBJECT_HEADER *pObjHeader)
{
  ...
  for(i = 0; i < pObjHeader->numberOfPoints; i++)
  {
    ...
    DNPDIAG_SHOW_BINARY_COUNTER(pSession, pointNumber, value, flags, TMWDEFS_TRUE, TMWDEFS_NULL);

    _storeBinaryCounter(pMDNPSession->pDbHandle, pointNumber, value, flags, TMWDEFS_NULL);
  }

  return(TMWDEFS_TRUE);
}
#endif /* MDNPDATA_SUPPORT_OBJ22_V1 */

#if MDNPDATA_SUPPORT_OBJ22_V2
/* function: mdnpo022_readObj22v2 */
TMWTYPES_BOOL TMWDEFS_GLOBAL mdnpo022_readObj22v2(
  TMWSESN *pSession,
  DNPUTIL_RX_MSG *pRxFragment,
  DNPUTIL_OBJECT_HEADER *pObjHeader)
{
...
#endif /* MDNPDATA_SUPPORT_OBJ22_V2 */

#if MDNPDATA_SUPPORT_OBJ22_V5
/* function: mdnpo022_readObj22v5 */
TMWTYPES_BOOL TMWDEFS_GLOBAL mdnpo022_readObj22v5(
  TMWSESN *pSession,
  DNPUTIL_RX_MSG *pRxFragment,
  DNPUTIL_OBJECT_HEADER *pObjHeader)
{
  ...
  for(i = 0; i < pObjHeader->numberOfPoints; i++)
  {
    ...
    DNPDIAG_SHOW_BINARY_COUNTER(pSession, pointNumber, value, flags, TMWDEFS_TRUE, &dateTime);

    _storeBinaryCounter(pMDNPSession->pDbHandle, pointNumber, value, flags, &dateTime);
  }

  return(TMWDEFS_TRUE);
}
#endif /* MDNPDATA_SUPPORT_OBJ22_V5 */

#if MDNPDATA_SUPPORT_OBJ22_V6
/* function: mdnpo022_readObj22v6 */
TMWTYPES_BOOL TMWDEFS_GLOBAL mdnpo022_readObj22v6(
  TMWSESN *pSession,
  DNPUTIL_RX_MSG *pRxFragment,
  DNPUTIL_OBJECT_HEADER *pObjHeader)
{
...
#endif /* MDNPDATA_SUPPORT_OBJ22_V6 */

#if MDNPDATA_SUPPORT_OBJ22
/* function: mdnpo022_readObj22 */
TMWTYPES_BOOL TMWDEFS_GLOBAL mdnpo022_readObj22(
  TMWSESN *pSession,
  DNPUTIL_RX_MSG *pRxFragment,
  DNPUTIL_OBJECT_HEADER *pObjHeader)
{
...
#if MDNPDATA_SUPPORT_OBJ22_V1
    case 1:
      status = mdnpo022_readObj22v1(pSession, pRxFragment, pObjHeader);
      break;
#endif
#if MDNPDATA_SUPPORT_OBJ22_V2
    case 2:
      status = mdnpo022_readObj22v2(pSession, pRxFragment, pObjHeader);
      break;
#endif
#if MDNPDATA_SUPPORT_OBJ22_V5
    case 5:
      status = mdnpo022_readObj22v5(pSession, pRxFragment, pObjHeader);
      break;
#endif
#if MDNPDATA_SUPPORT_OBJ22_V6
    case 6:
      status = mdnpo022_readObj22v6(pSession, pRxFragment, pObjHeader);
      break;
#endif
  }
  return(status);
