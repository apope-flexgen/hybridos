 ...
 *   DNP Master functionality for Object 50 Time and Date.
 */
#ifndef MDNPO050_DEFINED
#define MDNPO050_DEFINED
...
extern "C" {
   ...
   * purpose: Process read response for object 50 variation 1
   * arguments:
