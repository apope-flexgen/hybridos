 ...
 *   DNP Master functionality for Object 21 Frozen Counters.
 */
#ifndef MDNPO021_DEFINED
#define MDNPO021_DEFINED
...
extern "C" {
   ...
   * purpose: Process read response for object 21 any variation
   * arguments:
