 ...
 *   DNP Master functionality for Object 1 Binary Output Status.
 */
#ifndef MDNPO010_DEFINED
#define MDNPO010_DEFINED
...
extern "C" {
   ...
   * purpose: Process read response for object 10 variation 1
   * arguments:
   ...
   * purpose: Process read response for object 10 variation 2
   * arguments:
   *  pSession - identifies session
   *  pRxFragment - received fragment
   *  pObjHeader - object header for current data object
