 ...
 *   DNP Master functionality for Object 115 Extended String Events.
 */
#ifndef MDNPO115_DEFINED
#define MDNPO115_DEFINED
...
extern "C" {
   ...
   * purpose: Process read response for object 115 all variations
   * arguments:
