 ...
 *   DNP Master functionality for Object 42 Analog Output Change Events.
 */
#ifndef MDNPO042_DEFINED
#define MDNPO042_DEFINED
...
extern "C" {
   ...
   * purpose: Process read response for object 42 any variation
   * arguments:
