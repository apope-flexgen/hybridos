 ...
 *   DNP Master functionality for Object 114 Extended String Data.
 */
#ifndef MDNPO114_DEFINED
#define MDNPO114_DEFINED
...
extern "C" {
   ...
   * purpose: Process read response for object 114 all variations
   * arguments:
