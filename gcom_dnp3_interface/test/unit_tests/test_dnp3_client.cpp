...
std::vector<TMWSIM_POINT *> setupParseBodyClientTest(GcomSystem &sys)
{
...
TEST_SUITE("dnp3_client")
{
    ...
    TEST_CASE("parseBody - binary outputs - multi")
    {
        ...
        for (uint i = 0; i < tmwsim_tableSize(&((MDNPSIM_DATABASE *)(dnp3_sys->dbHandle))->binaryOutputs); i++)
        {
            ...
            if (dbPoint)
            {
                ...
                CHECK(dnp3_sys->CROBInfo[0].control == ((TMWTYPES_UCHAR)(value ? DNPDEFS_CROB_CTRL_LATCH_ON : DNPDEFS_CROB_CTRL_LATCH_OFF)));
                free(fims_message);
            }
        }
    ...
    TEST_CASE("updatePointCallback - direct"){
        ...
        for (uint i = 0; i < tmwsim_tableSize(&((MDNPSIM_DATABASE *)(dnp3_sys->dbHandle))->analogInputs); i++)
        {
            ...
            if (dbPoint)
            {
                ...
                updatePointCallback(sys.protocol_dependencies->dnp3.dbHandle, TMWSIM_POINT_UPDATE, DNPDEFS_OBJ_30_ANA_INPUTS, dbPoint->pointNumber);
        ...
        for (uint i = 0; i < tmwsim_tableSize(&((MDNPSIM_DATABASE *)(dnp3_sys->dbHandle))->binaryInputs); i++)
        {
            ...
            if (dbPoint)
            {
                ...
                updatePointCallback(sys.protocol_dependencies->dnp3.dbHandle, TMWSIM_POINT_UPDATE, DNPDEFS_OBJ_2_BIN_CHNG_EVENTS, dbPoint->pointNumber);
                CHECK(!((FlexPoint *)(dbPoint->flexPointHandle))->pub_timer.active);
            }
        }
        for (uint i = 0; i < tmwsim_tableSize(&((MDNPSIM_DATABASE *)(dnp3_sys->dbHandle))->analogOutputs); i++)
        {
            ...
            {
                dbPoint->data.analog.value = rand() % 100;
                updatePointCallback(sys.protocol_dependencies->dnp3.dbHandle, TMWSIM_POINT_UPDATE, DNPDEFS_OBJ_40_ANA_OUT_STATUSES, dbPoint->pointNumber);
                CHECK(!((FlexPoint *)(dbPoint->flexPointHandle))->pub_timer.active);
            }
        }
        for (uint i = 0; i < tmwsim_tableSize(&((MDNPSIM_DATABASE *)(dnp3_sys->dbHandle))->binaryOutputs); i++)
        {
            ...
            {
                dbPoint->data.binary.value = rand() % 2 == 0;
                updatePointCallback(sys.protocol_dependencies->dnp3.dbHandle, TMWSIM_POINT_UPDATE, DNPDEFS_OBJ_10_BIN_OUT_STATUSES, dbPoint->pointNumber);
                CHECK(!((FlexPoint *)(dbPoint->flexPointHandle))->pub_timer.active);
            }
        }
    ...
    //             addPointToPubWork(dbPoint);
    //             queuePubs(&sys);
    //             asprintf(&fims_message, "{\"%s\":%f,\"Timestamp\":", ((FlexPoint *)(dbPoint->flexPointHandle))->name.c_str(), dbPoint->data.analog.value/((FlexPoint *)(dbPoint->flexPointHandle))->scale);
    ...
    //             sprintf(append_str, "\"%s\":%f,", ((FlexPoint *)(dbPoint->flexPointHandle))->name.c_str(), dbPoint->data.analog.value/((FlexPoint *)(dbPoint->flexPointHandle))->scale);
    ...
    TEST_CASE("queuePubs - binary inputs"){
        ...
        for (uint i = 0; i < tmwsim_tableSize(&((MDNPSIM_DATABASE *)(dnp3_sys->dbHandle))->binaryInputs); i++)
        {
            ...
            if (dbPoint)
            {
                ...
                addPointToPubWork(dbPoint);
                queuePubs(&sys);
                asprintf(&fims_message, "{\"%s\":%s,\"Timestamp\":", ((FlexPoint *)(dbPoint->flexPointHandle))->name.c_str(), dbPoint->data.binary.value?"true":"false");
                CHECK(strncmp(sys.fims_dependencies->send_buf.data(),fims_message, strlen(fims_message)) == 0);
                free(fims_message);
            }
        }
        ...
        for (uint i = 0; i < tmwsim_tableSize(&((MDNPSIM_DATABASE *)(dnp3_sys->dbHandle))->analogInputs); i++)
        {
            ...
            if (dbPoint)
            {
                ...
                addPointToPubWork(dbPoint);
                memset(append_str,'\0',100);
                sprintf(append_str, "\"%s\":%s,", ((FlexPoint *)(dbPoint->flexPointHandle))->name.c_str(), dbPoint->data.binary.value?"true":"false");
                strcat(fims_message, append_str);
            }
        }
        strcat(fims_message, "\"Timestamp\":");
        ...
        for (uint i = 0; i < tmwsim_tableSize(&((MDNPSIM_DATABASE *)(dnp3_sys->dbHandle))->analogInputs); i++)
        {
            ...
            if (dbPoint)
            {
                ...
                addPointToPubWork(dbPoint);
                memset(append_str,'\0',100);
                sprintf(append_str, "\"%s\":%d,", ((FlexPoint *)(dbPoint->flexPointHandle))->name.c_str(), dbPoint->data.binary.value?1:0);
                strcat(fims_message, append_str);
            }
        }
        strcat(fims_message, "\"Timestamp\":");
        ...
        for (uint i = 0; i < tmwsim_tableSize(&((MDNPSIM_DATABASE *)(dnp3_sys->dbHandle))->analogInputs); i++)
        {
            ...
            if (dbPoint)
            {
                ...
                addPointToPubWork(dbPoint);
                memset(append_str,'\0',100);
                sprintf(append_str, "\"%s\":\"%s\",", ((FlexPoint *)(dbPoint->flexPointHandle))->name.c_str(), dbPoint->data.binary.value?"ON":"OFF");
                strcat(fims_message, append_str);
            }
        }
        strcat(fims_message, "\"Timestamp\":");
    ...
    //             addPointToPubWork(dbPoint);
    //             queuePubs(&sys);
    //             asprintf(&fims_message, "{\"%s\":{\"value\":%g},\"Timestamp\":", ((FlexPoint *)(dbPoint->flexPointHandle))->name.c_str(), dbPoint->data.analog.value/((FlexPoint *)(dbPoint->flexPointHandle))->scale);
    //             CHECK(strncmp(sys.fims_dependencies->send_buf.data(),fims_message, strlen(fims_message)) == 0);
    //             free(fims_message);
    //         }
    //     }
    ...
    //             addPointToPubWork(dbPoint);
    //             memset(append_str,'\0',100);
    //             sprintf(append_str, "\"%s\":{\"value\":%g},", ((FlexPoint *)(dbPoint->flexPointHandle))->name.c_str(), dbPoint->data.analog.value/((FlexPoint *)(dbPoint->flexPointHandle))->scale);
    //             strcat(fims_message, append_str);
    //         }
    //     }
    //     strcat(fims_message, "\"Timestamp\":");
    ...
    TEST_CASE("queuePubs - binary inputs clothed"){
        ...
        for (uint i = 0; i < tmwsim_tableSize(&((MDNPSIM_DATABASE *)(dnp3_sys->dbHandle))->binaryInputs); i++)
        {
            ...
            if (dbPoint)
            {
                ...
                addPointToPubWork(dbPoint);
                queuePubs(&sys);
                asprintf(&fims_message, "{\"%s\":{\"value\":%s},\"Timestamp\":", ((FlexPoint *)(dbPoint->flexPointHandle))->name.c_str(), dbPoint->data.binary.value?"true":"false");
                CHECK(strncmp(sys.fims_dependencies->send_buf.data(),fims_message, strlen(fims_message)) == 0);
                free(fims_message);
            }
        }
        ...
        for (uint i = 0; i < tmwsim_tableSize(&((MDNPSIM_DATABASE *)(dnp3_sys->dbHandle))->analogInputs); i++)
        {
            ...
            if (dbPoint)
            {
                ...
                addPointToPubWork(dbPoint);
                memset(append_str,'\0',100);
                sprintf(append_str, "\"%s\":{\"value\":%s},", ((FlexPoint *)(dbPoint->flexPointHandle))->name.c_str(), dbPoint->data.binary.value?"true":"false");
                strcat(fims_message, append_str);
            }
        }
        strcat(fims_message, "\"Timestamp\":");
        ...
        for (uint i = 0; i < tmwsim_tableSize(&((MDNPSIM_DATABASE *)(dnp3_sys->dbHandle))->analogInputs); i++)
        {
            ...
            if (dbPoint)
            {
                ...
                addPointToPubWork(dbPoint);
                memset(append_str,'\0',100);
                sprintf(append_str, "\"%s\":{\"value\":%d},", ((FlexPoint *)(dbPoint->flexPointHandle))->name.c_str(), dbPoint->data.binary.value?1:0);
                strcat(fims_message, append_str);
            }
        }
        strcat(fims_message, "\"Timestamp\":");
        ...
        for (uint i = 0; i < tmwsim_tableSize(&((MDNPSIM_DATABASE *)(dnp3_sys->dbHandle))->analogInputs); i++)
        {
            ...
            if (dbPoint)
            {
                ...
                addPointToPubWork(dbPoint);
                memset(append_str,'\0',100);
                sprintf(append_str, "\"%s\":{\"value\":\"%s\"},", ((FlexPoint *)(dbPoint->flexPointHandle))->name.c_str(), dbPoint->data.binary.value?"ON":"OFF");
                strcat(fims_message, append_str);
            }
        }
        strcat(fims_message, "\"Timestamp\":");
