...
TEST_SUITE("dnp3_point_utils")
{
  ...
  TEST_CASE("Test format_individual_bits with Clothed format")
  {
    ...
    CHECK_EQ(fmt::to_string(send_buf), R"("Bit0":{"value":false},"Bit1":{"value":false},"Bit2":{"value":true},"Bit3":{"value":false},"Bit4":{"value":true})");
  }
  ...
  TEST_CASE("Test format_individual_bits with Full format")
  {
    ...
    CHECK_EQ(fmt::to_string(send_buf), R"("Bit0":{"value":false,"flags":["ONLINE"],"timestamp":"null"},"Bit1":{"value":false,"flags":["ONLINE"],"timestamp":"null"},"Bit2":{"value":true,"flags":["ONLINE"],"timestamp":"null"},"Bit3":{"value":false,"flags":["ONLINE"],"timestamp":"null"},"Bit4":{"value":true,"flags":["ONLINE"],"timestamp":"null"})");
  }
