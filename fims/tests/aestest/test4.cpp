...
// Simple test file to examine AES conversion throughput
...
// compile with 
//  g++ -Ofast -o t4 test4.cpp gen_time.c -lssl -lcrypto
...
// cycle through a list of packet sizes showing throughput
int runTest(int runs, int bsize);
...
int main (int argc, char *argv[])
{
    ...
    int ix = 5;
    printf(" 1024 total cycles for each length:\n");
...
int runTest(int runs, int bsize) {
    ...
    printf("    --> %2.3f mS elapsed, length %4d throughput %2.3f MB/S\n",
     stime*1000.0, bsize, bsize /(stime*1024));
