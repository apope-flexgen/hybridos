// This file contains general file operations specific to Archive Cocoon but not specific to a particular step in the process
...
// Will delete file if the specified path is not configured or is the empty string.
