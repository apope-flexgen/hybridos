...
@ parametrize("test", [
    ...
    Steps(
        ...
        [
            Flex_Assertion(Assertion_Type.obj_eq, "/site/operation", [{'name': 'Asset Alarm Detected', 'return_value': 1}], pattern="active_alarms.options"),
    ...
    Steps(
        ...
        [
            Flex_Assertion(Assertion_Type.approx_eq, "/assets/ess/summary/ess_num_alarmed", 2, wait_secs=.1),
            Flex_Assertion(Assertion_Type.approx_eq, "/assets/ess/summary/ess_total_alarms", 2, wait_secs=.1),
        ]
    ),
    ...
    Steps(
        ...
        [
            Flex_Assertion(Assertion_Type.obj_eq, "/site/operation",[{"name": "Site Sequence Fault Detected", "return_value": 1}], pattern="active_faults.options"),
    ...
    Steps(
        ...
        [
            Flex_Assertion(Assertion_Type.approx_eq, "/assets/ess/summary/ess_num_faulted", 2, wait_secs=.1),
            Flex_Assertion(Assertion_Type.approx_eq, "/assets/ess/summary/ess_total_faults", 2, wait_secs=.1),
        ]
    ),
