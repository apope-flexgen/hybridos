...
fims_set_getStatus(){
    ...
    sleep 2
    fims_send -m get -u /assets/$1/status -r /Judsen
}
...
fims_set_getValue(){
    fims_send -m set -u /assets/$1/$2 $3
    sleep 2 
    fims_send -m get -u /assets/$1/$2 -r /Judsen
}
...
"exit_standby"
"limits_override"
"autobalancing_enable" don't test says jack
"autobalancing_disable" don't test says jack
...
then
    ...
    fims_send -m get -u /features/active_power/manual_solar_kW_cmd -r /Jud > currentTest.txt
    ./valueParse currentTest.txt -12
    sleep 0.1
    printf "        manual_ess_kW_cmd\n             "
    fims_send -m set -u /features/active_power/manual_ess_kW_cmd 12
    fims_send -m get -u /features/active_power/manual_ess_kW_cmd -r /Jud > currentTest.txt
    ./valueParse currentTest.txt 12
    sleep 0.1

    printf "        grid_target_kw_cmd\n             "
    fims_send -m set -u /features/active_power/grid_target_kW_cmd -- -12
    fims_send -m get -u /features/active_power/grid_target_kW_cmd -r /Jud > currentTest.txt
    ./valueParse currentTest.txt -12
    sleep 0.1

    printf "        export_target_kw_cmd\n             "
    fims_send -m set -u /features/active_power/export_target_kW_cmd 12
    fims_send -m get -u /features/active_power/export_target_kW_cmd -r /Jud > currentTest.txt
    ./valueParse currentTest.txt 12
    sleep 0.1

    printf "        export_target_kW_slew_rate\n             "
    fims_send -m set -u /features/active_power/export_target_kW_slew_rate -- -12
    fims_send -m get -u /features/active_power/export_target_kW_slew_rate -r /Jud > currentTest.txt
    ./valueParse currentTest.txt -12
    sleep 0.1

    printf "        fr_site_nominal_hz\n             "
    fims_send -m set -u /features/active_power/fr_site_nominal_hz 12
    fims_send -m get -u /features/active_power/fr_site_nominal_hz -r /Jud > currentTest.txt
    ./valueParse currentTest.txt 12
    sleep 0.1

    printf "        fr_offset_hz\n             "
    fims_send -m set -u /features/active_power/fr_offset_hz -- -12
    fims_send -m get -u /features/active_power/fr_offset_hz -r /Jud > currentTest.txt
    ./valueParse currentTest.txt -12
    sleep 0.1

    printf "        fr_baseload_kw_cmd\n             "
    fims_send -m set -u /features/active_power/fr_baseload_kW_cmd 12
    fims_send -m get -u /features/active_power/fr_baseload_kW_cmd -r /Jud > currentTest.txt
    ./valueParse currentTest.txt 12
    sleep 0.1

    printf "        fr_inactive_kw_cmd\n             "
    fims_send -m set -u /features/active_power/fr_inactive_kW_cmd -- -12
    fims_send -m get -u /features/active_power/fr_inactive_kW_cmd -r /Jud > currentTest.txt
    ./valueParse currentTest.txt -12
    sleep 0.1

    printf "        fr_total_kw_cmd\n             "
    fims_send -m set -u /features/active_power/fr_total_kW_cmd 12
    fims_send -m get -u /features/active_power/fr_total_kW_cmd -r /Jud > currentTest.txt
    ./valueParse currentTest.txt 12
    sleep 0.1

    printf "        fr_UF_active_kW_cmd\n             "
    fims_send -m set -u /features/active_power/fr_UF_active_kW_cmd -- -12
    fims_send -m get -u /features/active_power/fr_UF_active_kW_cmd -r /Jud > currentTest.txt
    ./valueParse currentTest.txt -12
    sleep 0.1

    printf "        fr_UF_droop_percent\n             "
    fims_send -m set -u /features/active_power/fr_UF_droop_percent 12
    fims_send -m get -u /features/active_power/fr_UF_droop_percent -r /Jud > currentTest.txt
    ./valueParse currentTest.txt 12
    sleep 0.1

    printf "        fr_UF_hz_trigger_percent\n             "
    fims_send -m set -u /features/active_power/fr_UF_hz_trigger_percent -- -12
    fims_send -m get -u /features/active_power/fr_UF_hz_trigger_percent -r /Jud > currentTest.txt
    ./valueParse currentTest.txt -12
    sleep 0.1

    printf "        fr_UF_hz_recover_percent\n             "
    fims_send -m set -u /features/active_power/fr_UF_hz_recover_percent 12
    fims_send -m get -u /features/active_power/fr_UF_hz_recover_percent -r /Jud > currentTest.txt
    ./valueParse currentTest.txt 12
    sleep 0.1

    printf "        fr_UF_hz_instant_recover_percent\n             "
    fims_send -m set -u /features/active_power/fr_UF_hz_instant_recover_percent -- -12
    fims_send -m get -u /features/active_power/fr_UF_hz_instant_recover_percent -r /Jud > currentTest.txt
    ./valueParse currentTest.txt -12
    sleep 0.1

    printf "        fr_UF_slew_rate\n             "
    fims_send -m set -u /features/active_power/fr_UF_slew_rate 12
    fims_send -m get -u /features/active_power/fr_UF_slew_rate -r /Jud > currentTest.txt
    ./valueParse currentTest.txt 12
    sleep 0.1
 
    printf "        fr_UF_trigger_time\n             "
    fims_send -m set -u /features/active_power/fr_UF_trigger_time 12
    fims_send -m get -u /features/active_power/fr_UF_trigger_time -r /Jud > currentTest.txt
    ./valueParse currentTest.txt 12
    sleep 0.1
 
    printf "        fr_UF_cooldown_time\n             "
    fims_send -m set -u /features/active_power/fr_UF_cooldown_time 12
    fims_send -m get -u /features/active_power/fr_UF_cooldown_time -r /Jud > currentTest.txt
    ./valueParse currentTest.txt 12
    sleep 0.1
 
    printf "        fr_UF_recover_time\n             "
    fims_send -m set -u /features/active_power/fr_UF_recover_time 12
    fims_send -m get -u /features/active_power/fr_UF_recover_time -r /Jud > currentTest.txt
    ./valueParse currentTest.txt 12
    sleep 0.1
    ...
    fims_send -m get -u /features/active_power/fr_OF_active_kW_cmd -r /Jud > currentTest.txt
    ./valueParse currentTest.txt 12
    sleep 0.1

    printf "        fr_OF_droop_percent\n             "
    fims_send -m set -u /features/active_power/fr_OF_droop_percent 12
    fims_send -m get -u /features/active_power/fr_OF_droop_percent -r /Jud > currentTest.txt
    ./valueParse currentTest.txt 12
    sleep 0.1

    printf "        fr_OF_hz_trigger_percent\n             "
    fims_send -m set -u /features/active_power/fr_OF_hz_trigger_percent 12
    fims_send -m get -u /features/active_power/fr_OF_hz_trigger_percent -r /Jud > currentTest.txt
    ./valueParse currentTest.txt 12
    sleep 0.1

    printf "        fr_OF_hz_recover_percent\n             "
    fims_send -m set -u /features/active_power/fr_OF_hz_recover_percent 12
    fims_send -m get -u /features/active_power/fr_OF_hz_recover_percent -r /Jud > currentTest.txt
    ./valueParse currentTest.txt 12
    sleep 0.1

    printf "        fr_OF_hz_instant_recover_percent\n             "
    fims_send -m set -u /features/active_power/fr_OF_hz_instant_recover_percent 12
    fims_send -m get -u /features/active_power/fr_OF_hz_instant_recover_percent -r /Jud > currentTest.txt
    ./valueParse currentTest.txt 12
    sleep 0.1

    printf "        fr_OF_slew_rate\n             "
    fims_send -m set -u /features/active_power/fr_OF_slew_rate 12
    fims_send -m get -u /features/active_power/fr_OF_slew_rate -r /Jud > currentTest.txt
    ./valueParse currentTest.txt 12
    sleep 0.1
 
    printf "        fr_OF_trigger_time\n             "
    fims_send -m set -u /features/active_power/fr_OF_trigger_time 12
    fims_send -m get -u /features/active_power/fr_OF_trigger_time -r /Jud > currentTest.txt
    ./valueParse currentTest.txt 12
    sleep 0.1
 
    printf "        fr_OF_cooldown_time\n             "
    fims_send -m set -u /features/active_power/fr_OF_cooldown_time 12
    fims_send -m get -u /features/active_power/fr_OF_cooldown_time -r /Jud > currentTest.txt
    ./valueParse currentTest.txt 12
    sleep 0.1
 
    printf "        fr_OF_recover_time\n             "
    fims_send -m set -u /features/active_power/fr_OF_recover_time 12
    fims_send -m get -u /features/active_power/fr_OF_recover_time -r /Jud > currentTest.txt
    ./valueParse currentTest.txt 12
    sleep 0.1
 
    printf "        threshold_charge_1\n             "
    fims_send -m set -u /features/active_power/threshold_charge_1 12
    fims_send -m get -u /features/active_power/threshold_charge_1 -r /Jud > currentTest.txt
    ./valueParse currentTest.txt 12
    sleep 0.1
 
    printf "        threshold_charge_2\n             "
    fims_send -m set -u /features/active_power/threshold_charge_2 12
    fims_send -m get -u /features/active_power/threshold_charge_2 -r /Jud > currentTest.txt
    ./valueParse currentTest.txt 12
    sleep 0.1
 
    printf "        threshold_dischg_1\n             "
    fims_send -m set -u /features/active_power/threshold_dischg_1 12
    fims_send -m get -u /features/active_power/threshold_dischg_1 -r /Jud > currentTest.txt
    ./valueParse currentTest.txt 12
    sleep 0.1
 
    printf "        threshold_dischg_2\n             "
    fims_send -m set -u /features/active_power/threshold_dischg_2 12
    fims_send -m get -u /features/active_power/threshold_dischg_2 -r /Jud > currentTest.txt
    ./valueParse currentTest.txt 12
    sleep 0.1
 
    printf "        max_charge_1\n             "
    fims_send -m set -u /features/active_power/max_charge_1 12
    fims_send -m get -u /features/active_power/max_charge_1 -r /Jud > currentTest.txt
    ./valueParse currentTest.txt 12
    sleep 0.1
 
    printf "        max_charge_2\n             "
    fims_send -m set -u /features/active_power/max_charge_2 12
    fims_send -m get -u /features/active_power/max_charge_2 -r /Jud > currentTest.txt
    ./valueParse currentTest.txt 12
    sleep 0.1
 
    printf "        max_dischg_1\n             "
    fims_send -m set -u /features/active_power/max_dischg_1 12
    fims_send -m get -u /features/active_power/max_dischg_1 -r /Jud > currentTest.txt
    ./valueParse currentTest.txt 12
    sleep 0.1
 
    printf "        max_dischg_2\n             "
    fims_send -m set -u /features/active_power/max_dischg_2 12
    fims_send -m get -u /features/active_power/max_dischg_2 -r /Jud > currentTest.txt
    ./valueParse currentTest.txt 12
    sleep 0.1
 
    printf "        price\n             "
    fims_send -m set -u /features/active_power/price 12
    fims_send -m get -u /features/active_power/price -r /Jud > currentTest.txt
    ./valueParse currentTest.txt 12
    sleep 0.1
...
<<potentialbug
    ...
    fims_send -m get -u /features/active_power/pfr_limits_min_kW -r /Jud > currentTest.txt
    ./valueParse currentTest.txt 12
 
    printf "        pfr_limits_max_kW\n             "
    fims_send -m set -u /features/active_power/pfr_limits_max_kW 12
    fims_send -m get -u /features/active_power/pfr_limits_max_kW -r /Jud > currentTest.txt
    ./valueParse currentTest.txt 12
potentialbug

    printf "        absolute_ess_kW_cmd\n             "
    fims_send -m set -u /features/active_power/absolute_ess_kW_cmd 12
    fims_send -m get -u /features/active_power/absolute_ess_kW_cmd -r /Jud > currentTest.txt
    ./valueParse currentTest.txt 12
    sleep 0.1
 
    printf "        ess_charge_control_target_soc\n             "
    fims_send -m set -u /features/active_power/ess_charge_control_target_soc 12
    fims_send -m get -u /features/active_power/ess_charge_control_target_soc -r /Jud > currentTest.txt
    ./valueParse currentTest.txt 12
    sleep 0.1
 
    printf "        ess_charge_control_kW_limit\n             "
    fims_send -m set -u /features/active_power/ess_charge_control_kW_limit 12
    fims_send -m get -u /features/active_power/ess_charge_control_kW_limit -r /Jud > currentTest.txt
    ./valueParse currentTest.txt 12
    sleep 0.1
    ...
    fims_send -m get -u /features/reactive_power/runmode1_kVAR_mode_cmd -r /Jud > currentTest.txt
    ...
    fims_send -m get -u /features/reactive_power/reactive_setpoint_kVAR_cmd -r /Jud > currentTest.txt
    ./valueParse currentTest.txt 12
    sleep 0.1
 
    printf "        active_voltage_cmd\n             "
    fims_send -m set -u /features/reactive_power/active_voltage_cmd 12
    fims_send -m get -u /features/reactive_power/active_voltage_cmd -r /Jud > currentTest.txt
    ./valueParse currentTest.txt 12
    sleep 0.1
 
    printf "        active_voltage_deadband\n             "
    fims_send -m set -u /features/reactive_power/active_voltage_deadband 12
    fims_send -m get -u /features/reactive_power/active_voltage_deadband -r /Jud > currentTest.txt
    ./valueParse currentTest.txt 12
    sleep 0.1
 
    printf "        active_voltage_droop_percent\n             "
    fims_send -m set -u /features/reactive_power/active_voltage_droop_percent 12
    fims_send -m get -u /features/reactive_power/active_voltage_droop_percent -r /Jud > currentTest.txt
    ./valueParse currentTest.txt 12
    sleep 0.1

    printf "        power_factor_cmd\n             "
    fims_send -m set -u /features/reactive_power/power_factor_cmd 0.55
    fims_send -m get -u /features/reactive_power/power_factor_cmd -r /Jud > currentTest.txt
...
<<no
    ...
    fims_send -m get -u /features/standalone_power/start_first_gen_soc -r /Jud > currentTest.txt
    ./valueParse currentTest.txt 12
    sleep 0.1

    printf "        edp_soc\n             "
    fims_send -m set -u /features/standalone_power/edp_soc 12
    fims_send -m get -u /features/standalone_power/edp_soc -r /Jud > currentTest.txt
    ./valueParse currentTest.txt 12
    sleep 0.1
no
    ...
    fims_send -m get -u /features/standalone_power/_closed_loop_control_manual_offset -r /Jud > currentTest.txt
    ./valueParse currentTest.txt 12
    sleep 0.1
...
<<watchdog
    ...
    fims_send -m get -u /features/site_operation/watchdog_pet -r /Jud > currentTest.txt
    ./valueParse currentTest.txt 12
    sleep 0.1

    printf "        watchdog_duration_ms\n             "
    fims_send -m set -u /features/site_operation/watchdog_duration_ms 5000
    fims_send -m get -u /features/site_operation/watchdog_duration_ms -r /Jud > currentTest.txt
    ./valueParse currentTest.txt 12
    sleep 0.1
watchdog
    ...
    fims_send -m get -u /site/configuration/reserved_float_1 -r /Jud > currentTest.txt
    ./valueParse currentTest.txt 12
    sleep 0.1

    printf "        reserved_float_2\n             "
    fims_send -m set -u /site/configuration/reserved_float_2 12
    fims_send -m get -u /site/configuration/reserved_float_2 -r /Jud > currentTest.txt
    ./valueParse currentTest.txt 12
    sleep 0.1

    printf "        reserved_float_3\n             "
    fims_send -m set -u /site/configuration/reserved_float_3 12
    fims_send -m get -u /site/configuration/reserved_float_3 -r /Jud > currentTest.txt
    ./valueParse currentTest.txt 12
    sleep 0.1

    printf "        reserved_float_4\n             "
    fims_send -m set -u /site/configuration/reserved_float_4 12
    fims_send -m get -u /site/configuration/reserved_float_4 -r /Jud > currentTest.txt
    ./valueParse currentTest.txt 12
    sleep 0.1

    printf "        reserved_float_5\n             "
    fims_send -m set -u /site/configuration/reserved_float_5 12
    fims_send -m get -u /site/configuration/reserved_float_5 -r /Jud > currentTest.txt
    ./valueParse currentTest.txt 12
    sleep 0.1

    printf "        reserved_float_6\n             "
    fims_send -m set -u /site/configuration/reserved_float_6 12
    fims_send -m get -u /site/configuration/reserved_float_6 -r /Jud > currentTest.txt
    ./valueParse currentTest.txt 12
    sleep 0.1

    printf "        reserved_float_7\n             "
    fims_send -m set -u /site/configuration/reserved_float_7 12
    fims_send -m get -u /site/configuration/reserved_float_7 -r /Jud > currentTest.txt
    ./valueParse currentTest.txt 12
    sleep 0.1

    printf "        reserved_float_8\n             "
    fims_send -m set -u /site/configuration/reserved_float_8 12
    fims_send -m get -u /site/configuration/reserved_float_8 -r /Jud > currentTest.txt
    ./valueParse currentTest.txt 12
    sleep 0.1
    ...
    fims_send -m get -u /features/active_power/ess_charge_control_discharge_disable -r /Jud > currentTest.txt
    ./valueParse currentTest.txt true
    sleep 0.1

    printf "        charge_dispatch_solar_enable_flag\n             "
    fims_send -m set -u /features/active_power/charge_dispatch_solar_enable_flag true
    fims_send -m get -u /features/active_power/charge_dispatch_solar_enable_flag -r /Jud > currentTest.txt
    ./valueParse currentTest.txt true
    sleep 0.1

    printf "        charge_dispatch_gen_enable_flag\n             "
    fims_send -m set -u /features/active_power/charge_dispatch_gen_enable_flag true
    fims_send -m get -u /features/active_power/charge_dispatch_gen_enable_flag -r /Jud > currentTest.txt
    ./valueParse currentTest.txt true
    sleep 0.1

    printf "        charge_dispatch_feeder_enable_flag\n             "
    fims_send -m set -u /features/active_power/charge_dispatch_feeder_enable_flag true
    fims_send -m get -u /features/active_power/charge_dispatch_feeder_enable_flag -r /Jud > currentTest.txt
    ./valueParse currentTest.txt true
    sleep 0.1
    ...
    fims_send -m get -u /features/active_power/charge_dispatch_solar_dischg_priority_flag -r /Jud > currentTest.txt
    ./valueParse currentTest.txt true
    sleep 0.1

    printf "        target_soc_load_enable_flag\n             "
    fims_send -m set -u /features/active_power/target_soc_load_enable_flag true
    fims_send -m get -u /features/active_power/target_soc_load_enable_flag -r /Jud > currentTest.txt
    ./valueParse currentTest.txt true
    sleep 0.1

    printf "        export_target_load_enable_flag\n             "
    fims_send -m set -u /features/active_power/export_target_load_enable_flag true
    fims_send -m get -u /features/active_power/export_target_load_enable_flag -r /Jud > currentTest.txt
    ./valueParse currentTest.txt true
    sleep 0.1
    ...
    fims_send -m get -u /features/standalone_power/poi_limits_enable -r /Jud > currentTest.txt
    ./valueParse currentTest.txt true
    sleep 0.1

    printf "        soc_poi_limits_enable\n             "
    fims_send -m set -u /features/standalone_power/soc_poi_limits_enable true
    fims_send -m get -u /features/standalone_power/soc_poi_limits_enable -r /Jud > currentTest.txt
    ./valueParse currentTest.txt true
    sleep 0.1

    printf "        pfr_enable_flag\n             "
    fims_send -m set -u /features/standalone_power/pfr_enable_flag true
    fims_send -m get -u /features/standalone_power/pfr_enable_flag -r /Jud > currentTest.txt
    ./valueParse currentTest.txt true
    sleep 0.1

    printf "        watt_watt_adjustment_enable_flag\n             "
    fims_send -m set -u /features/standalone_power/watt_watt_adjustment_enable_flag true
    fims_send -m get -u /features/standalone_power/watt_watt_adjustment_enable_flag -r /Jud > currentTest.txt
    ./valueParse currentTest.txt true
    sleep 0.1

    printf "        ldss_enable_flag\n             "
    fims_send -m set -u /features/standalone_power/ldss_enable_flag true
    fims_send -m get -u /features/standalone_power/ldss_enable_flag -r /Jud > currentTest.txt
    ./valueParse currentTest.txt true
    sleep 0.1

    printf "        load_shed_enable\n             "
    fims_send -m set -u /features/standalone_power/load_shed_enable true
    fims_send -m get -u /features/standalone_power/load_shed_enable -r /Jud > currentTest.txt
    ./valueParse currentTest.txt true
    sleep 0.1

    printf "        solar_shed_enable\n             "
    fims_send -m set -u /features/standalone_power/solar_shed_enable true
    fims_send -m get -u /features/standalone_power/solar_shed_enable -r /Jud > currentTest.txt
    ./valueParse currentTest.txt true
    sleep 0.1

    printf "        closed_loop_control_enable\n             "
    fims_send -m set -u /features/standalone_power/closed_loop_control_enable true
    fims_send -m get -u /features/standalone_power/closed_loop_control_enable -r /Jud > currentTest.txt
    ./valueParse currentTest.txt true
    sleep 0.1

    printf "        edp_enable\n             "
    fims_send -m set -u /features/standalone_power/edp_enable true
    fims_send -m get -u /features/standalone_power/edp_enable -r /Jud > currentTest.txt
    ./valueParse currentTest.txt true
    sleep 0.1
...
<<watchdog
    ...
    fims_send -m get -u /features/site_operation/watchdog_enable -r /Jud > currentTest.txt
    ./valueParse currentTest.txt false
    sleep 0.1
watchdog
...
<<no
    ...
    fims_send -m get -u /site/operation/primary_controller -r /Jud > currentTest.txt
    ./valueParse currentTest.txt true
    sleep 0.1

    printf "        dbi_update\n"
    fims_send -m set -u /site/operation/dbi_update true
    fims_send -m get -u /site/operation/dbi_update -r /Jud > currentTest.txt
    ./valueParse currentTest.txt true
    sleep 0.1
no
    ...
    fims_send -m get -u /site/operation/disable_flag -r /Jud > currentTest.txt
    ./valueParse currentTest.txt true
    sleep 0.1

    printf "        enable_flag\n           "
    fims_send -m set -u /site/operation/enable_flag true
    fims_send -m get -u /site/operation/enable_flag -r /Jud > currentTest.txt
    ./valueParse currentTest.txt true
    sleep 0.1

    printf "        standby_flag\n          "
    fims_send -m set -u /site/operation/standby_flag true
    fims_send -m get -u /site/operation/standby_flag -r /Jud > currentTest.txt
    ./valueParse currentTest.txt true
    sleep 0.1
    ...
    fims_send -m get -u /site/operation/clear_faults_flag -r /Jud > currentTest.txt
    ./valueParse currentTest.txt true
    sleep 0.1
...
<<no
    ...
    fims_send -m get -u /site/input_sources -r /Jud > currentTest.txt
    ./valueParse currentTest.txt true
    sleep 0.1
no
