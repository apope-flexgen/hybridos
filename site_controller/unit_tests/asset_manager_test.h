...
TEST_F(asset_manager_test, asset_create) {
    ...
    test_cases.push_back({ UNIT_TEST_FILES_PATH + "assets/invalid_wildcard.json", Config_Validation_Result(false), Config_Validation_Result(true), Config_Validation_Result(true), Config_Validation_Result(true), {}, {}, {}, {} });
