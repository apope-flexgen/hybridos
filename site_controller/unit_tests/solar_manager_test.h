...
TEST_F(solar_manager_test, solar_curtailment)
{
    ...
    tests.push_back({2,            100,              200,               200,              200,                    0.05,     no_curtailment,          no_curtailment,
                     {100,100},                      {100,100}});
    tests.push_back({2,            100,              150,               200,              150,                    0.05,     no_curtailment,          partial_curtailment,
                     {100,100},                      {100,50}});
    tests.push_back({2,            100,              150,               150,              140,                    0.05,     partial_curtailment,     no_curtailment,
                     {75,75},                        {100,100}});
    tests.push_back({2,            100,              50,                150,              150,                    0.05,     partial_curtailment,     full_curtailment,
                     {75,75},                        {50,0}});
    tests.push_back({2,            100,              120,               100,              100,                    0.05,     full_curtailment,        partial_curtailment,
                     {100,0},                        {100,20}});
    tests.push_back({2,            100,              90,                88,               88,                     0.05,     full_curtailment,        full_curtailment,
                     {88,0},                         {90,0}});
    // test the case of a non-prime inverter generating more power than the prime inverter while in partial curtailment
    tests.push_back({3,            100,              250,               250,              250,                    0.05,     partial_curtailment,     partial_curtailment,
                     {80,70,100},                    {100,70,100}});
    tests.push_back({3,            100,              180,               280,              280,                    0.05,     partial_curtailment,     partial_curtailment,
                     {80,100,100},                   {100,50,50}});
