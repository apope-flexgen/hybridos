...
features::Reactive_Power_Closed_Loop_Control::Reactive_Power_Closed_Loop_Control() {
    ...
    variable_ids = {
        ...
        { &step_size_kW, "reactive_power_closed_loop_step_size_kVAR" },
        ...
        { &steady_state_deadband_kW, "reactive_power_closed_loop_steady_state_deadband_kVAR" },
        { &regulation_deadband_kW, "reactive_power_closed_loop_regulation_deadband_kVAR" },
