...
std::map<spdlog::level::level_enum, std::string> severity_names = {
    std::make_pair(spdlog::level::trace, "Trace"),  std::make_pair(spdlog::level::debug, "Debug"), std::make_pair(spdlog::level::info, "Info"),
    std::make_pair(spdlog::level::warn, "Warning"), std::make_pair(spdlog::level::err, "Error"),   std::make_pair(spdlog::level::critical, "Critical"),
};
