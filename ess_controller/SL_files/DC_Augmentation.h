...
public:
    ...
    // Constructor
    DC_Augmentation_class(ExtUPointer* rtExtUPointer_l, ExtYPointer* rtExtYPointer_o);
...
private:
    ...
    static void DcdcRampRate_Init(self_DcdcRampRate* DC_Augmentation_self_arg, real_T rtu_pCmd, real_T* rty_pOut);
    static void DcdcRampRate(self_DcdcRampRate* DC_Augmentation_self_arg, real_T rtu_kWperS, real_T rtu_pCmd,
                             real_T rtu_updtRate, real_T rtu_pLast, real_T* rty_pOut);
