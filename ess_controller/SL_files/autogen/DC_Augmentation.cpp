...
const boolean_T CLOSED{ true };        // Referenced by: '<S2>/Chart'
...
//    '<S1>/PcsRampRate'
//
void DC_Augmentation_class::DcdcRampRate_Init(self_DcdcRampRate
  *DC_Augmentation_self_arg, real_T rtu_pCmd, real_T *rty_pOut)
{
...
//    '<S1>/PcsRampRate'
//
void DC_Augmentation_class::DcdcRampRate(self_DcdcRampRate
  *DC_Augmentation_self_arg, real_T rtu_kWperS, real_T rtu_pCmd, real_T
  rtu_updtRate, real_T rtu_pLast, real_T *rty_pOut)
{
...
void DC_Augmentation_class::step()
{
  ...
  if (rtDW.is_active_c1_DC_Augmentation == 0U) {
    ...
    rtDW.offcmd = 0.0;
    if (ExtUPointer_ref_U->StartStop) {
      rtDW.oncmd = 1.0;
    }
    ...
    if (rtDW.is_Start_Stop_Handler == IN_Off) {
      ...
      } else if (ExtUPointer_ref_U->StartStop) {
        rtDW.oncmd = 1.0;
      }
      ...
      if (ExtUPointer_ref_U->DcaFltActv != 0.0) {
        ...
        switch (rtDW.is_NoFault) {
         ...
         case IN_Off_j:
          ...
          if (rtDW.oncmd != 0.0) {
            ...
            if ((ExtUPointer_ref_U->BMS_1_DCDisconnectStt == CLOSED) &&
                ...
                ExtUPointer_ref_U->DCDC_1_Status &&
                ExtUPointer_ref_U->PCS_1_Status) {
         ...
         case IN_Startup:
          // Outport: '<Root>/DcaMode'
          ExtYPointer_ref_Y->DcaMode = static_cast<real_T>(STARTUP);
          if ((ExtUPointer_ref_U->MaintCmd != 0.0) && (rtDW.startupComplete !=
               0.0)) {
            rtDW.is_NoFault = IN_Maintenance;
  ...
  rtb_Sum = ExtUPointer_ref_U->BMS_2_Capacity +
    ExtUPointer_ref_U->BMS_1_Capacity;
  ...
  if (rtDW.is_active_c2_DC_Augmentation == 0U) {
    ...
    if (ExtYPointer_ref_Y->DcaMode == RUN) {
      ...
      if (ExtYPointer_ref_Y->RunMode == RUN_BALANCE) {
        ...
        rtDW.DcdcPcmd = ExtUPointer_ref_U->BMS_2_Capacity / rtb_Sum *
          rtDW.ActvPwrCmd;
    ...
    switch (rtDW.is_On) {
     case IN_BalanceSOC:
      if ((ExtYPointer_ref_Y->RunMode == RUN_DEFAULT) ||
          (ExtYPointer_ref_Y->RunMode == RUN_OFF)) {
        rtDW.is_BalanceSOC = 0;
        rtDW.is_On = IN_Standby;
        rtDW.PcsPcmd = 0.0;
        rtDW.DcdcPcmd = 0.0;
     ...
     default:
      ...
      if (ExtYPointer_ref_Y->RunMode == RUN_BALANCE) {
        ...
        rtDW.DcdcPcmd = ExtUPointer_ref_U->BMS_2_Capacity / rtb_Sum *
          rtDW.ActvPwrCmd;
        rtDW.PcsQcmd = rtb_ReactvPwrCmd;
      } else if ((ExtYPointer_ref_Y->RunMode == RUN_DEFAULT) ||
                 (ExtYPointer_ref_Y->RunMode == RUN_OFF)) {
        rtDW.is_On = IN_Standby;
        rtDW.PcsPcmd = 0.0;
        rtDW.DcdcPcmd = 0.0;
  ...
  rtb_dcaModeLast = 0.0;
  if (ExtYPointer_ref_Y->RunMode == RUN_BALANCE) {
    rtb_DcdcChrgPlim = (std::abs(ExtUPointer_ref_U->BMS_2_ChargePwrLim) <=
                        ExtUPointer_ref_U->DCDC_1_Plim ? std::abs
                        (ExtUPointer_ref_U->BMS_2_ChargePwrLim) :
                        ExtUPointer_ref_U->DCDC_1_Plim) <= std::abs
      (ExtUPointer_ref_U->BMS_1_DischargePwrLim) -
      ExtUPointer_ref_U->PCS_1_ActivePower ? std::abs
      (ExtUPointer_ref_U->BMS_2_ChargePwrLim) <= ExtUPointer_ref_U->DCDC_1_Plim ?
      std::abs(ExtUPointer_ref_U->BMS_2_ChargePwrLim) :
        ExtUPointer_ref_U->DCDC_1_Plim : std::abs
        (ExtUPointer_ref_U->BMS_1_DischargePwrLim) -
      ExtUPointer_ref_U->PCS_1_ActivePower;
    rtb_DcdcDischgPlim = (std::abs(ExtUPointer_ref_U->BMS_2_DischargePwrLim) <=
                          ExtUPointer_ref_U->DCDC_1_Plim ? std::abs
                          (ExtUPointer_ref_U->BMS_2_DischargePwrLim) :
                          ExtUPointer_ref_U->DCDC_1_Plim) <= std::abs
      (ExtUPointer_ref_U->BMS_1_ChargePwrLim) +
      ExtUPointer_ref_U->PCS_1_ActivePower ? std::abs
      (ExtUPointer_ref_U->BMS_2_DischargePwrLim) <=
      ExtUPointer_ref_U->DCDC_1_Plim ? std::abs
      (ExtUPointer_ref_U->BMS_2_DischargePwrLim) :
        ...
        (ExtUPointer_ref_U->BMS_1_ChargePwrLim) +
      ExtUPointer_ref_U->PCS_1_ActivePower;
    rtb_ReactvPwrCmd = ExtUPointer_ref_U->PCS_1_Plim <= std::abs
      (ExtUPointer_ref_U->BMS_1_ChargePwrLim) - ExtUPointer_ref_U->DCDC_1_Power ?
      ExtUPointer_ref_U->PCS_1_Plim : std::abs
      (ExtUPointer_ref_U->BMS_1_ChargePwrLim) - ExtUPointer_ref_U->DCDC_1_Power;
    rtb_dcaModeLast = ExtUPointer_ref_U->PCS_1_Plim <= std::abs
      (ExtUPointer_ref_U->BMS_1_DischargePwrLim) +
      ExtUPointer_ref_U->DCDC_1_Power ? ExtUPointer_ref_U->PCS_1_Plim : std::abs
      (ExtUPointer_ref_U->BMS_1_DischargePwrLim) +
      ExtUPointer_ref_U->DCDC_1_Power;
  } else if (ExtYPointer_ref_Y->RunMode == RUN_SUPPORT) {
    rtb_DcdcChrgPlim = (ExtUPointer_ref_U->PCS_1_Plim <=
                        ExtUPointer_ref_U->DCDC_1_Plim ?
                        ExtUPointer_ref_U->PCS_1_Plim :
                        ExtUPointer_ref_U->DCDC_1_Plim) <= std::abs
      (ExtUPointer_ref_U->BMS_2_ChargePwrLim) ? ExtUPointer_ref_U->PCS_1_Plim <=
      ExtUPointer_ref_U->DCDC_1_Plim ? ExtUPointer_ref_U->PCS_1_Plim :
      ExtUPointer_ref_U->DCDC_1_Plim : std::abs
      (ExtUPointer_ref_U->BMS_2_ChargePwrLim);
    rtb_DcdcDischgPlim = (ExtUPointer_ref_U->PCS_1_Plim <=
                          ExtUPointer_ref_U->DCDC_1_Plim ?
                          ExtUPointer_ref_U->PCS_1_Plim :
                          ExtUPointer_ref_U->DCDC_1_Plim) <= std::abs
      (ExtUPointer_ref_U->BMS_2_DischargePwrLim) ? ExtUPointer_ref_U->PCS_1_Plim
      <= ExtUPointer_ref_U->DCDC_1_Plim ? ExtUPointer_ref_U->PCS_1_Plim :
      ExtUPointer_ref_U->DCDC_1_Plim : std::abs
      (ExtUPointer_ref_U->BMS_2_DischargePwrLim);
  ...
  DcdcRampRate(&self_sf_DcdcRampRate, ExtUPointer_ref_U->DCDC_1_PRamp,
               rtDW.Switch, 0.1, rtb_Sum, &ExtYPointer_ref_Y->DCDC_1_Pcmd);
  ...
  DcdcRampRate(&self_sf_PcsQRampRate, ExtUPointer_ref_U->PCS_1_Qramp,
               rtDW.Switch4, 0.1, rtDW.Delay2_DSTATE,
  ...
  DcdcRampRate(&self_sf_PcsRampRate, ExtUPointer_ref_U->PCS_1_PRamp,
               rtDW.Switch2, 0.1, rtb_DcdcChrgPlim,
...
void DC_Augmentation_class::initialize()
{
  ...
  DcdcRampRate_Init(&self_sf_DcdcRampRate, rtDW.Switch,
                    &ExtYPointer_ref_Y->DCDC_1_Pcmd);

  // SystemInitialize for Chart: '<S1>/PcsQRampRate' incorporates:
  //   Outport: '<Root>/PCS_1_Qcmd'

  DcdcRampRate_Init(&self_sf_PcsQRampRate, rtDW.Switch4,
                    &ExtYPointer_ref_Y->PCS_1_Qcmd);

  // SystemInitialize for Chart: '<S1>/PcsRampRate' incorporates:
  //   Outport: '<Root>/PCS_1_Pcmd'

  DcdcRampRate_Init(&self_sf_PcsRampRate, rtDW.Switch2,
                    &ExtYPointer_ref_Y->PCS_1_Pcmd);
}

// set method for External inputs (root inport signals)
void DC_Augmentation_class::setExternalInputs(const DC_Augmentation_class::
  ExtUPointer &ExtUPointer_U)
{
  *ExtUPointer_ref_U = ExtUPointer_U;
}

// get method for External outputs (root outport signals)
const DC_Augmentation_class::ExtYPointer &DC_Augmentation_class::
...
// Constructor
DC_Augmentation_class::DC_Augmentation_class(ExtUPointer *rtExtUPointer_l,
  ExtYPointer *rtExtYPointer_o) :
  ExtUPointer_ref_U(),
  ExtYPointer_ref_Y(),
  rtDW(),
  self_sf_PcsRampRate(),
