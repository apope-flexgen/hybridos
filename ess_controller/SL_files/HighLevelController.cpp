...
void HighLevelController::step()
{
    ...
    if (HighLevelController_U.In1 != 0u)
    {
        tmp = 1;
    }
    else
...
// Constructor
HighLevelController::HighLevelController() : HighLevelController_U(), HighLevelController_Y(), HighLevelController_M()
{
...
HighLevelController::RT_MODEL_HighLevelController_T* HighLevelController::getRTM()
{
