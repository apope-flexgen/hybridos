...
std::unordered_map<std::string, std::unordered_map<int, std::unique_ptr<DC_Augmentation_class::ExtUPointer>>>
    DC_AugmentationInputs;
std::unordered_map<std::string, std::unordered_map<int, std::unique_ptr<DC_Augmentation_class::ExtYPointer>>>
    DC_AugmentationOutputs;
...
void createNewDC_AugmentationInstance(std::string uri, int instance)
{
    ...
    DC_Augmentation_class* dmDC_AugmentationObject = new DC_Augmentation_class(dmDC_AugmentationInput,
                                                                               dmDC_AugmentationOutput);
...
void setupDC_AugmentationDM(assetVar* aV, int instance)
{
    ...
    inputName = "StartVal";
    dm->addDataItem((char*)inputName.c_str(), offsetof(DC_Augmentation_class::ExtUPointer, StartVal),
                    DataMapType::REAL_T);
    dm->addTransferItem(inputBlock, inputName.c_str(), inputName.c_str());

    inputName = "StopVal";
    dm->addDataItem((char*)inputName.c_str(), offsetof(DC_Augmentation_class::ExtUPointer, StopVal),
                    DataMapType::REAL_T);
    dm->addTransferItem(inputBlock, inputName.c_str(), inputName.c_str());

    inputName = "FltClr";
    dm->addDataItem((char*)inputName.c_str(), offsetof(DC_Augmentation_class::ExtUPointer, FltClr),
                    DataMapType::REAL_T);
    dm->addTransferItem(inputBlock, inputName.c_str(), inputName.c_str());

    inputName = "MaintCmd";
    dm->addDataItem((char*)inputName.c_str(), offsetof(DC_Augmentation_class::ExtUPointer, MaintCmd),
                    DataMapType::REAL_T);
    dm->addTransferItem(inputBlock, inputName.c_str(), inputName.c_str());

    inputName = "DcaFltActv";
    dm->addDataItem((char*)inputName.c_str(), offsetof(DC_Augmentation_class::ExtUPointer, DcaFltActv),
                    DataMapType::REAL_T);
    dm->addTransferItem(inputBlock, inputName.c_str(), inputName.c_str());

    inputName = "BMS_1_SOC";
    dm->addDataItem((char*)inputName.c_str(), offsetof(DC_Augmentation_class::ExtUPointer, BMS_1_SOC),
                    DataMapType::REAL_T);
    dm->addTransferItem(inputBlock, inputName.c_str(), inputName.c_str());

    inputName = "BMS_1_Volts";
    dm->addDataItem((char*)inputName.c_str(), offsetof(DC_Augmentation_class::ExtUPointer, BMS_1_Volts),
                    DataMapType::REAL_T);
    dm->addTransferItem(inputBlock, inputName.c_str(), inputName.c_str());

    inputName = "BMS_1_Current";
    dm->addDataItem((char*)inputName.c_str(), offsetof(DC_Augmentation_class::ExtUPointer, BMS_1_Current),
                    DataMapType::REAL_T);
    dm->addTransferItem(inputBlock, inputName.c_str(), inputName.c_str());

    inputName = "BMS_1_Capacity";
    dm->addDataItem((char*)inputName.c_str(), offsetof(DC_Augmentation_class::ExtUPointer, BMS_1_Capacity),
                    DataMapType::REAL_T);
    dm->addTransferItem(inputBlock, inputName.c_str(), inputName.c_str());

    inputName = "BMS_1_ChargePwrLim";
    dm->addDataItem((char*)inputName.c_str(), offsetof(DC_Augmentation_class::ExtUPointer, BMS_1_ChargePwrLim),
                    DataMapType::REAL_T);
    dm->addTransferItem(inputBlock, inputName.c_str(), inputName.c_str());

    inputName = "BMS_1_DischargePwrLim";
    dm->addDataItem((char*)inputName.c_str(), offsetof(DC_Augmentation_class::ExtUPointer, BMS_1_DischargePwrLim),
                    DataMapType::REAL_T);
    dm->addTransferItem(inputBlock, inputName.c_str(), inputName.c_str());

    inputName = "BMS_1_ChargeCurrentLim";
    dm->addDataItem((char*)inputName.c_str(), offsetof(DC_Augmentation_class::ExtUPointer, BMS_1_ChargeCurrentLim),
                    DataMapType::REAL_T);
    dm->addTransferItem(inputBlock, inputName.c_str(), inputName.c_str());

    inputName = "BMS_1_DischargeCurrentLim";
    dm->addDataItem((char*)inputName.c_str(), offsetof(DC_Augmentation_class::ExtUPointer, BMS_1_DischargeCurrentLim),
                    DataMapType::REAL_T);
    dm->addTransferItem(inputBlock, inputName.c_str(), inputName.c_str());

    inputName = "BMS_2_SOC";
    dm->addDataItem((char*)inputName.c_str(), offsetof(DC_Augmentation_class::ExtUPointer, BMS_2_SOC),
                    DataMapType::REAL_T);
    dm->addTransferItem(inputBlock, inputName.c_str(), inputName.c_str());

    inputName = "BMS_2_Volts";
    dm->addDataItem((char*)inputName.c_str(), offsetof(DC_Augmentation_class::ExtUPointer, BMS_2_Volts),
                    DataMapType::REAL_T);
    dm->addTransferItem(inputBlock, inputName.c_str(), inputName.c_str());

    inputName = "BMS_2_Current";
    dm->addDataItem((char*)inputName.c_str(), offsetof(DC_Augmentation_class::ExtUPointer, BMS_2_Current),
                    DataMapType::REAL_T);
    dm->addTransferItem(inputBlock, inputName.c_str(), inputName.c_str());

    inputName = "BMS_2_Capacity";
    dm->addDataItem((char*)inputName.c_str(), offsetof(DC_Augmentation_class::ExtUPointer, BMS_2_Capacity),
                    DataMapType::REAL_T);
    dm->addTransferItem(inputBlock, inputName.c_str(), inputName.c_str());

    inputName = "BMS_2_ChargePwrLim";
    dm->addDataItem((char*)inputName.c_str(), offsetof(DC_Augmentation_class::ExtUPointer, BMS_2_ChargePwrLim),
                    DataMapType::REAL_T);
    dm->addTransferItem(inputBlock, inputName.c_str(), inputName.c_str());

    inputName = "BMS_2_DischargePwrLim";
    dm->addDataItem((char*)inputName.c_str(), offsetof(DC_Augmentation_class::ExtUPointer, BMS_2_DischargePwrLim),
                    DataMapType::REAL_T);
    dm->addTransferItem(inputBlock, inputName.c_str(), inputName.c_str());

    inputName = "BMS_2_ChargeCurrentLim";
    dm->addDataItem((char*)inputName.c_str(), offsetof(DC_Augmentation_class::ExtUPointer, BMS_2_ChargeCurrentLim),
                    DataMapType::REAL_T);
    dm->addTransferItem(inputBlock, inputName.c_str(), inputName.c_str());

    inputName = "BMS_2_DischargeCurrentLim";
    dm->addDataItem((char*)inputName.c_str(), offsetof(DC_Augmentation_class::ExtUPointer, BMS_2_DischargeCurrentLim),
                    DataMapType::REAL_T);
    dm->addTransferItem(inputBlock, inputName.c_str(), inputName.c_str());

    inputName = "DCDC_1_V1";
    dm->addDataItem((char*)inputName.c_str(), offsetof(DC_Augmentation_class::ExtUPointer, DCDC_1_V1),
                    DataMapType::REAL_T);
    dm->addTransferItem(inputBlock, inputName.c_str(), inputName.c_str());

    inputName = "DCDC_1_V2";
    dm->addDataItem((char*)inputName.c_str(), offsetof(DC_Augmentation_class::ExtUPointer, DCDC_1_V2),
                    DataMapType::REAL_T);
    dm->addTransferItem(inputBlock, inputName.c_str(), inputName.c_str());

    inputName = "DCDC_1_Current";
    dm->addDataItem((char*)inputName.c_str(), offsetof(DC_Augmentation_class::ExtUPointer, DCDC_1_Current),
                    DataMapType::REAL_T);
    dm->addTransferItem(inputBlock, inputName.c_str(), inputName.c_str());

    inputName = "DCDC_1_Power";
    dm->addDataItem((char*)inputName.c_str(), offsetof(DC_Augmentation_class::ExtUPointer, DCDC_1_Power),
                    DataMapType::REAL_T);
    dm->addTransferItem(inputBlock, inputName.c_str(), inputName.c_str());

    inputName = "DCDC_1_Plim";
    dm->addDataItem((char*)inputName.c_str(), offsetof(DC_Augmentation_class::ExtUPointer, DCDC_1_Plim),
                    DataMapType::REAL_T);
    dm->addTransferItem(inputBlock, inputName.c_str(), inputName.c_str());

    inputName = "PCS_1_DcVlt";
    dm->addDataItem((char*)inputName.c_str(), offsetof(DC_Augmentation_class::ExtUPointer, PCS_1_DcVlt),
                    DataMapType::REAL_T);
    dm->addTransferItem(inputBlock, inputName.c_str(), inputName.c_str());

    inputName = "PCS_1_DcCurrent";
    dm->addDataItem((char*)inputName.c_str(), offsetof(DC_Augmentation_class::ExtUPointer, PCS_1_DcCurrent),
                    DataMapType::REAL_T);
    dm->addTransferItem(inputBlock, inputName.c_str(), inputName.c_str());

    inputName = "PCS_1_ActivePower";
    dm->addDataItem((char*)inputName.c_str(), offsetof(DC_Augmentation_class::ExtUPointer, PCS_1_ActivePower),
                    DataMapType::REAL_T);
    dm->addTransferItem(inputBlock, inputName.c_str(), inputName.c_str());

    inputName = "PCS_1_Plim";
    dm->addDataItem((char*)inputName.c_str(), offsetof(DC_Augmentation_class::ExtUPointer, PCS_1_Plim),
                    DataMapType::REAL_T);
    dm->addTransferItem(inputBlock, inputName.c_str(), inputName.c_str());

    inputName = "PCS_1_Qlim";
    dm->addDataItem((char*)inputName.c_str(), offsetof(DC_Augmentation_class::ExtUPointer, PCS_1_Qlim),
                    DataMapType::REAL_T);
    dm->addTransferItem(inputBlock, inputName.c_str(), inputName.c_str());

    inputName = "PCS_1_PRamp";
    dm->addDataItem((char*)inputName.c_str(), offsetof(DC_Augmentation_class::ExtUPointer, PCS_1_PRamp),
                    DataMapType::REAL_T);
    dm->addTransferItem(inputBlock, inputName.c_str(), inputName.c_str());

    inputName = "PCS_1_Qramp";
    dm->addDataItem((char*)inputName.c_str(), offsetof(DC_Augmentation_class::ExtUPointer, PCS_1_Qramp),
                    DataMapType::REAL_T);
    dm->addTransferItem(inputBlock, inputName.c_str(), inputName.c_str());

    inputName = "DCDC_1_PRamp";
    dm->addDataItem((char*)inputName.c_str(), offsetof(DC_Augmentation_class::ExtUPointer, DCDC_1_PRamp),
                    DataMapType::REAL_T);
    dm->addTransferItem(inputBlock, inputName.c_str(), inputName.c_str());

    inputName = "DCDC_1_PNom";
    dm->addDataItem((char*)inputName.c_str(), offsetof(DC_Augmentation_class::ExtUPointer, DCDC_1_PNom),
                    DataMapType::REAL_T);
    dm->addTransferItem(inputBlock, inputName.c_str(), inputName.c_str());

    inputName = "BMS_1_PNom";
    dm->addDataItem((char*)inputName.c_str(), offsetof(DC_Augmentation_class::ExtUPointer, BMS_1_PNom),
                    DataMapType::REAL_T);
    dm->addTransferItem(inputBlock, inputName.c_str(), inputName.c_str());

    inputName = "BMS_2_PNom";
    dm->addDataItem((char*)inputName.c_str(), offsetof(DC_Augmentation_class::ExtUPointer, BMS_2_PNom),
                    DataMapType::REAL_T);
    dm->addTransferItem(inputBlock, inputName.c_str(), inputName.c_str());

    inputName = "StartStop";
    dm->addDataItem((char*)inputName.c_str(), offsetof(DC_Augmentation_class::ExtUPointer, StartStop),
                    DataMapType::BOOLEAN_T);
    dm->addTransferItem(inputBlock, inputName.c_str(), inputName.c_str());

    inputName = "BMS_1_DCDisconnectStt";
    dm->addDataItem((char*)inputName.c_str(), offsetof(DC_Augmentation_class::ExtUPointer, BMS_1_DCDisconnectStt),
                    DataMapType::BOOLEAN_T);
    dm->addTransferItem(inputBlock, inputName.c_str(), inputName.c_str());

    inputName = "BMS_2_DCDisconnectStt";
    dm->addDataItem((char*)inputName.c_str(), offsetof(DC_Augmentation_class::ExtUPointer, BMS_2_DCDisconnectStt),
                    DataMapType::BOOLEAN_T);
    dm->addTransferItem(inputBlock, inputName.c_str(), inputName.c_str());

    inputName = "DCDC_1_Status";
    dm->addDataItem((char*)inputName.c_str(), offsetof(DC_Augmentation_class::ExtUPointer, DCDC_1_Status),
                    DataMapType::BOOLEAN_T);
    dm->addTransferItem(inputBlock, inputName.c_str(), inputName.c_str());

    inputName = "PCS_1_Status";
    dm->addDataItem((char*)inputName.c_str(), offsetof(DC_Augmentation_class::ExtUPointer, PCS_1_Status),
                    DataMapType::BOOLEAN_T);
    dm->addTransferItem(inputBlock, inputName.c_str(), inputName.c_str());

    // Output data items and transfer blocks
    std::string outputName = "DCDC_1_Pcmd";
    dm->addDataItem((char*)outputName.c_str(), offsetof(DC_Augmentation_class::ExtYPointer, DCDC_1_Pcmd),
                    DataMapType::REAL_T);
    dm->addTransferItem(outputBlock, outputName.c_str(), outputName.c_str());

    outputName = "PCS_1_Pcmd";
    dm->addDataItem((char*)outputName.c_str(), offsetof(DC_Augmentation_class::ExtYPointer, PCS_1_Pcmd),
                    DataMapType::REAL_T);
    dm->addTransferItem(outputBlock, outputName.c_str(), outputName.c_str());

    outputName = "PCS_1_Qcmd";
    dm->addDataItem((char*)outputName.c_str(), offsetof(DC_Augmentation_class::ExtYPointer, PCS_1_Qcmd),
                    DataMapType::REAL_T);
    dm->addTransferItem(outputBlock, outputName.c_str(), outputName.c_str());

    outputName = "DcaMode";
    dm->addDataItem((char*)outputName.c_str(), offsetof(DC_Augmentation_class::ExtYPointer, DcaMode),
                    DataMapType::REAL_T);
    dm->addTransferItem(outputBlock, outputName.c_str(), outputName.c_str());

    outputName = "RunMode";
    dm->addDataItem((char*)outputName.c_str(), offsetof(DC_Augmentation_class::ExtYPointer, RunMode),
                    DataMapType::REAL_T);
    dm->addTransferItem(outputBlock, outputName.c_str(), outputName.c_str());
}
...
void setupDC_AugmentationAmap(VarMapUtils* vm, varsmap& vmap, asset_manager* am, int instance, std::string uri)
{
    ...
    if (debug)
        FPS_PRINT_INFO("Setting up datamap to amap interface for {} using amap of asset manager: [{}]", ctrlDCA,
                       am->name);
...
void setupDC_Augmentation(varsmap& vmap, varmap& amap, const char* aname, fims* p_fims, assetVar* aV)
{
    ...
    tmp.erase(tmp.begin());
    std::string instanceAMname = tmp + "_DC_Augmentation_" + std::to_string(instance) + "_asset_manager";
