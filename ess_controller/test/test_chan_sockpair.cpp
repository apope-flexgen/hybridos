 ...
 * We want to say run this list of functions (each with its ownthis av)
 * (in|every) 10 Seconds run ({fun1, (av1,av2,av3)}, {fun2,{av1,av2,av3}},
 * "in"|"every" 0.5 secs ) this will need varadic lists running .. and events
 * the sock pair is used to wake a poll up before its time but I dont think we
 * need that
 */
