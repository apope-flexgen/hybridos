 ...
 * test vlink
 *
 * defined to test the setValfromCj function that reads all kinds of objects
 * into the varsma....
 */
#include "alarm.h"
#include "asset.h"
...
// ReplyTo: (null)
// Body:
// {"frequency":60.003,"voltage_l1":7443,"voltage_l2":7397,"voltage_l3":7410,"current_l1":10,"current_l2":15,"current_l3":21,"current_n":44,"active_power":11.706,
//           "reactive_power":-152.031,"power_factor":0.03,"apparent_power":368.154,"Timestamp":"07-23-2020
//           14:46:28.514502"}
...
// TODO DONE we alsocreate an assetlist for this one. if we see "name" then its
// all one thing all other things are params

// TODO check set /a/b/c:ar@param

// TODO create an ALIST regardless of UiObject  well use a VEC instead (TODO)
// new params will append but it removes the whole alist thing....
...
int main()
{
    ...
    const char* myval3 =
        "{\"value123\":123,\"value234\":234,\"value235\":235}";  //  {\"maxVal\":215,\"moreminVal\":53}}";
    ...
    const char* var1 =
        ...
        "\"/system/remap_controls\",\"var\":\"start_stop1\"},"
        "{ \"bit\":1, \"scale\":10.0,\"offset\":200,\"uri\": "
        "\"/system/remap_controls\",\"var\":\"start_stop2\"},"
        "{ \"bit\":3, \"scale\":10.0,\"offset\":200,\"uri\": "
        "\"/system/remap_controls\",\"var\":\"start_stop3\"}"
        "]"
        "}"
        "}"
        "}"
    ...
    const char* var2 =
        ...
        "\"onSet\":{"
        "\"remap\":["
        "{ \"bit\":4, \"scale\":10.0,\"offset\":200,\"uri\": "
        "\"/system/remap_controls\",\"var\":\"start_stop1\"},"
        "{ \"bit\":5, \"scale\":10.0,\"offset\":200,\"uri\": "
        "\"/system/remap_controls\",\"var\":\"start_stop2\"},"
        "{ \"bit\":6, \"scale\":10.0,\"offset\":200,\"uri\": "
        "\"/system/remap_controls\",\"var\":\"start_stop3\"}"
        "]"
        "}"
        "}"
    ...
    const char* var3 =
        ...
        "{ \"bit\":5, \"scale\":10.0,\"offset\":200,\"uri\": "
        "\"/system/remap_controls\",\"var\":\"start_stop2\"},"
        "{ \"bit\":6, \"scale\":1.0,\"offset\":0,\"uri\": "
        "\"/system/remap_controls:start_stop1@test_param\"}"
        "],"
        "\"enum\":["
        "{ \"bit\":4, \"scale\":10.0,\"offset\":200,\"uri\": "
        "\"/system/remap_controls\",\"var\":\"start_stop1\"},"
    ...
    const char* var4 =
        "{\"name\":\"This is my "
        "name\",\"i234\":234,\"s235\":\"235\",\"aLastParam\":0."
        "123}";  //  {\"maxVal\":215,\"moreminVal\":53}}";
    const char* var5 =
        "{\"name\":\"This is my name\",\"value\":34.5, "
        "\"i234\":234,\"s235\":\"235\",\"aLastParam\":0.123}";  //  {\"maxVal\":215,\"moreminVal\":53}}";

    const char* var6 =
        "{\"name\":\"This is my name\",\"value\":34.5, "
        "\"params\":{\"i234\":234,\"s235\":\"235\",\"aLastParam\":"
        "0.123}}";  //  {\"maxVal\":215,\"moreminVal\":53}}";

    const char* var7 =
        "{\"name\":\"This is my name\",\"value\":34.5, "
        "\"options\":[{\"firstOption\":234},{\"amidOption\":\"235\"},{"
        "\"aLastOption\":0.123}]}}";  //  {\"maxVal\":215,\"moreminVal\":53}}";

    const char* var8 =
        "{"
        "\"name\":\"Ess Controller\","
        "\"active_power\":          {\"name\": \"Active Power\",          "
        "\"value\": 17,        \"unit\": \"W\", \"scaler\": 1000, \"enabled\": "
        "false, \"ui_type\": \"status\", \"type\": \"number\"},"
        "\"active_power_setpoint\": {\"name\": \"Active Power Setpoint\", "
        "\"value\": 3.0999999, \"unit\": \"W\", \"scaler\": 1000, \"enabled\": "
        "false, \"ui_type\": \"status\", \"type\": \"number\"},"
        "\"alarms\":                {\"name\": \"Alarms\",       \"value\": 0, "
        "\"options\": [], \"unit\": \"\",  \"scaler\": 0,    \"enabled\": true,  "
        "\"ui_type\": \"alarm\", \"type\": \"number\" },"
        "\"soc\": {\"name\": \"State of Charge\",                \"value\": "
        "76.559135,          \"unit\": \"%\", \"scaler\": 1,    \"enabled\": "
        "false, \"ui_type\": \"status\", \"type\": \"number\"},"
        "\"soh\": {\"name\": \"State of Health\",                \"value\": 0,   "
        "               \"unit\": \"%\", \"scaler\": 1,    \"enabled\": false, "
        "\"ui_type\": \"status\", \"type\": \"number\"},"
        "\"status\": {\"name\": \"Status\",                      \"value\": "
        "\"Run\",            \"unit\": \"\",  \"scaler\": 0,    \"enabled\": "
        "true,  \"ui_type\": \"status\", \"type\": \"number\"},"
        "\"maint_mode\": {\"name\": \"Maintenance Mode\",        \"value\": "
        "false,       \"unit\": \"\",  \"scaler\": 0,    \"enabled\": true,  "
        "\"ui_type\": \"control\", \"type\": \"enum_slider\","
        "\"options\": ["
    ...
    // /sites/ess
    const char* var9_1 =
        "{\"name\":\"Min Cell Volts\",\"value\":34.5 "
        ",\"range\":4567,\"somestrng\":\"site variable\"}";
    // /components/catl_mbmu_control_r
    const char* var9_2 =
        "{\"name\":\"ModBus Min Cell Volts\",\"value\":3.5 "
        ",\"offset\":3456,\"someptherparam\":\"modbus "
        "variable\"}";
    // vlinks/ess
    const char* var9_3 =
        "{\"val\":true, "
        "\"vlink\":\"/components/"
        "catl_mbmu_control_r:mbmu_min_cell_voltage\", "
        "\"value\":\"/site/ess:MinCellVolts\"}";
    ...
    {
        printf(" dval9_2 av9_1->[%s:%s]->linkVar %p is %2.3f \n", av9_1->comp.c_str(), av9_1->name.c_str(),
               av9_1->linkVar, dval9_2);
        // delete av2;
    }
    cJSON_Delete(cj5);
    cj5 = vm.getMapsCj(vmap, nullptr, nullptr, 0x0110);
    ...
    // __func__, av9_2->getdVal()); av9_2->closePerf();
