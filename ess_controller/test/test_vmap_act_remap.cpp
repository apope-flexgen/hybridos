...
int test_main(int argc, char *argv[])
{
    ...
    const char *var1= "{\"start_stop\":{\"value\":0,"
            "\"actions\":{"
                 "\"onSet\":[{"
                    "\"remap\":["
                        "{ \"bit\":0, \"scale\":10.0,\"offset\":200,\"uri\": \"/system/remap_controls\",\"var\":\"rm_start_stop\"}"
                    "]}"
            "]}"
        "}"
    "}";
    const char* rep1 = "{\"start_stop\":{\"value\":0,\"actions\":{\"onSet\":[{\"remap\":"
                       "[{\"bit\":0,\"scale\":10,\"offset\":200,\"uri\":\"/system/remap_controls\",\"var\":\"rm_start_stop\"}]}]}}}";

    //const char *
        var1a = "{\"start_bool\":{\"value\":true,"
            "\"actions\":{"
                 "\"onSet\":[{"
                    "\"remap\":["
                        "{ \"uri\": \"/system/remap_bool:rm_start_stop\",\"outValue\":0},"
                        "{ \"inValue\":true, \"uri\": \"/system/remap_bool:rm_start_stop[2]\",\"outValue\":false},"
                        "{ \"inValue\":false, \"uri\": \"/system/remap_bool:rm_start_stop[2]\",\"outValue\":true}"
            "]}"
        "]}"
    "}}";

    rep1a = "{\"start_bool\":{\"value\":true,\"actions\":{\"onSet\":[{\"remap\":["
                        "{\"uri\":\"/system/remap_bool:rm_start_stop\",\"outValue\":0},"
                        "{\"inValue\":true,\"uri\":\"/system/remap_bool:rm_start_stop[2]\",\"outValue\":false},"
                        "{\"inValue\":false,\"uri\":\"/system/remap_bool:rm_start_stop[2]\",\"outValue\":true}"
                       "]}]}}}";
    ...
    const char* rep3 ="{\"bms_1\":{\"start_bool\":{\"value\":true,\"actions\":{\"onSet\":[{\"remap\":[{\"outValue\":0,\"uri\":\"/system/remap_bool:rm_start_stop\"}"
    ",{\"inValue\":true,\"outValue\":false,\"uri\":\"/system/remap_bool:rm_start_stop[2]\"},{\"inValue\":false,\"outValue\":true,\"uri\":\"/system/remap_bool:rm_start_stop[2]\"}]}]}}"
    ",\"start_stop\":{\"value\":0,\"actions\":{\"onSet\":[{\"remap\":[{\"bit\":0,\"offset\":200,\"scale\":10,\"uri\":\"/system/remap_controls\",\"var\":\"rm_start_stop\"}]}]}}}}";
