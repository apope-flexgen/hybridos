...
// HOW TO BUILD:
// g++ -std=c++11 -O2 -Wall -Wextra -Wpedantic -Wconversion -Wshadow -DSPDLOG_COMPILED_LIB -I include/ path/to/file/test_logging_timestamp.cpp -lspdlog -o test_logging_timestamp && ./test_logging_timestamp
