...
int test_main(int argc, char* argv[])
{
    ...
    //     asprintf(&rbuf,"{\"method\":\"set\",\"uri\":\"/components/sungrow_ess_1\",\"body\":{\"close_dc_contactors\":true,\"stop_start\":345}}");
    //     //{\"close_dc_contactors\":{\"value\":true}}}"); msg =
    //     vm.bufferToFims((const char *)rbuf); if(msg)
    //     {
    //         cJSON* cj =cJSON_CreateObject();
    ...
    //     asprintf(&rbuf,"{\"method\":\"set\",\"uri\":\"/setup/bms\",\"body\":{\"test_f1\":1234,\"test_f2\":456}}");
    //     //{\"close_dc_contactors\":{\"value\":true}}}"); msg =
    //     vm.bufferToFims((const char *)rbuf); if(msg)
    //     {
    //         cJSON* cj =cJSON_CreateObject();
    ...
    //     asprintf(&rbuf,"{\"method\":\"set\",\"uri\":\"/alarms/bms\",\"body\":{\"fault_f1\":1234,\"fault_f2\":456}}");
    //     //{\"close_dc_contactors\":{\"value\":true}}}"); msg =
    //     vm.bufferToFims((const char *)rbuf); if(msg)
    //     {
    //         cJSON* cj =cJSON_CreateObject();
    ...
    //     // this will run the process_alarms   function for test_f1
    //     asprintf(&rbuf,"{\"method\":\"set\",\"uri\":\"/alarms/bms\",\"body\":{\"fault_f1\":12345,\"fault_f2\":4567}}");
    //     //{\"close_dc_contactors\":{\"value\":true}}}"); msg =
    //     vm.bufferToFims((const char *)rbuf); if(msg)
    //     {
    //         cJSON* cj =cJSON_CreateObject();
    ...
    //     asprintf(&rbuf,"{\"method\":\"set\",\"uri\":\"/test/bms\",\"body\":{\"test_f1\":12345,\"test_f2\":4567}}");
    //     //{\"close_dc_contactors\":{\"value\":true}}}"); msg =
    //     vm.bufferToFims((const char *)rbuf); if(msg)
    //     {
    //         cJSON* cj =cJSON_CreateObject();
    ...
    //     vm.setAvFunc(vmap, amap,/*av13->am->amap,*/ "bms", nullptr, av13,
    //     "RunAmBmsStatus", CheckAmBmsStatus);
    ...
    //     //assetVar* setActVecfromCj(assetVar* av, const char* act, const char*
    //     opt, cJSON* cjbf, cJSON* cj)
    //     //assetVar* setActVecfromCj(assetVar* av, "onSet", "enum", cjbf, cJSON*
    //     cj)
    //         // add an action.
    //     assetAction aa("MyName");

    //     cJSON*cjbf = cJSON_Parse("{
    //     \"enable\":\"/we/can/do/this:var\",\"anIntVar\":678}");
    ...
    //     cjbf = cJSON_Parse("[{
    //     \"enable\":\"/status/ess:UiEnabled\",\"inValue\":true,\"uri\":\"/controls/ess:maint_active_power_setpoint@enabled\",\"outValue\":true}]");
    ...
    // // Also how do we remove / replace lines... reinstall the bit field.on
    // write the bit field spaces by 5 to allow insert
    ...
    //     // now set a value "true" to  testIntVar  but that was in the wrong
    //     vmap... assetVar* av2 = vmap2["/config/ess/test"]["testBoolVar"];

    //     FPS_ERROR_PRINT("%s >> did we find av2 ?? %p\n",
    //     __func__, av2);

    //     FPS_ERROR_PRINT("%s >> setval direct to 4567 \n",
    //     __func__); av2->setVal(4567); //this bypasses any
    //     setval actions  Is this a Bug ?? ival = 5678; FPS_ERROR_PRINT("%s >>
    //     setval via vm to 5678 \n", __func__);
    //     vm.setVal(vmap2, "/config/ess/test", "testIntVar", ival);  //Well this
    //     seemed to work.
    ...
    //     __func__); vm.setVal(vmap2, "/config/ess/test",
    //     "testBoolVar", bval);  //Well this seemed to work. FPS_ERROR_PRINT("%s
    //     >> setval via vm to [true] done \n", __func__);
