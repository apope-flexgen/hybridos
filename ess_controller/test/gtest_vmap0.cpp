...
TEST_F(Vmap0, vmap0test){
    ...
    char*eres=(char*)"{\"/comp/ess\":{\"ess\":{\"myvar\":{\"value\":true}}},\"/components/vmap_test\":{\"vmap_test\":{\"test_float\":{\"value\":456.78},\"test_int\":{\"value\":123},\"test_string\":{\"value\":\"some_string_thing\"},\"test_string2\":{\"value\":\"some_string_value\"}}},\"/system/status\":{\"status\":{\"active_current_setpoint\":{\"value\":2000},\"soc\":{\"value\":100},\"status\":{\"value\":\"standby\"}}}}";
    EXPECT_STREQ(eres, res);

    //naked 0x0001
    cj = vm.getMapsCj(vmap, nullptr, nullptr, 1);
    res = cJSON_PrintUnformatted(cj);
    eres =(char*)"{\"/comp/ess\":{\"ess\":{\"myvar\":true}},\"/components/vmap_test\":{\"vmap_test\":{\"test_float\":456.78,\"test_int\":123,\"test_string\":\"some_string_thing\",\"test_string2\":\"some_string_value\"}},\"/system/status\":{\"status\":{\"active_current_setpoint\":2000,\"soc\":100,\"status\":\"standby\"}}}";
    EXPECT_STREQ(eres, res);

    //individual tables 0x001
    cj = vm.getMapsCj(vmap, nullptr, nullptr, 0x01);
    res = cJSON_PrintUnformatted(cj);
    eres =(char*)"{\"/comp/ess\":{\"ess\":{\"myvar\":true}},\"/components/vmap_test\":{\"vmap_test\":{\"test_float\":456.78,\"test_int\":123,\"test_string\":\"some_string_thing\",\"test_string2\":\"some_string_value\"}},\"/system/status\":{\"status\":{\"active_current_setpoint\":2000,\"soc\":100,\"status\":\"standby\"}}}";    EXPECT_STREQ(eres, res);
}
