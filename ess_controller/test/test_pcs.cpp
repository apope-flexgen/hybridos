...
// this is done to make the config correct  and can be skipped when the config is set up
// you can use the config generated by this test as the basis of the real config
// move this to vm
// int setup(varsmap &vmap, const char* link)
// {
...
//     vm.setVal2(vmap, link,"lastActivePowerSetpoint",   slastActivePowerSetpoint);
//     vm.setVal2(vmap, link,"lastReactivePowerSetpoint", slastReactivePowerSetpoint);
...
//     amap["AcContactorCloseCmd"]       = vm.linkVal(vmap, link, "AcContactorCloseCmd",    fval);
//     amap["AcContactorOpenCmd"]        = vm.linkVal(vmap, link, "AcContactorOpenCmd",     fval);
//     amap["DcContactor"]               = vm.linkVal(vmap, link, "DcContactor",            fval);
//     amap["DcContactorCloseCmd"]       = vm.linkVal(vmap, link, "DcContactorCloseCmd",    fval);
//     amap["DcContactorOpenCmd"]        = vm.linkVal(vmap, link, "DcContactorOpenCmd",     fval);
//     amap["StandbyCmd"]                = vm.linkVal(vmap, link, "StandbyCmd",             fval);
//     amap["Standby"]                   = vm.linkVal(vmap, link, "Standby",                fval);
//     amap["OnCmd"]                     = vm.linkVal(vmap, link, "OnCmd",                  fval);
//     amap["On"]                        = vm.linkVal(vmap, link, "On",                     fval);
//     amap["OffCmd"]                    = vm.linkVal(vmap, link, "OffCmd",                 fval);
//     amap["Off"]                       = vm.linkVal(vmap, link, "Off",                    fval);
//     amap["ActivePowerSetpoint"]       = vm.linkVal(vmap, link, "ActivePowerSetpoint",    dval);
//     amap["ReactivePowerSetpoint"]     = vm.linkVal(vmap, link, "ReactivePowerSetpoint",  dval);
//     amap["ActivePowerDeadband"]       = vm.linkVal(vmap, link, "ActivePowerDeadband",    dbval);
//     amap["ReactivePowerDeadband"]     = vm.linkVal(vmap, link, "ReactivePowerDeadband",  dbval);
//     amap["lastActivePowerSetpoint"]   = vm.linkVal(vmap, link, "lastActivePowerSetpoint",   dval);
//     amap["lastReactivePowerSetpoint"] = vm.linkVal(vmap, link, "lastReactivePowerSetpoint", dval);
//     amap["ActivePower"]               = vm.linkVal(vmap, link, "ActivePower",                   dval);
//     amap["ReactivePower"]             = vm.linkVal(vmap, link, "ReactivePower",                 dval);
//     amap["maxActivePower"]            = vm.linkVal(vmap, link, "maxActivePower",                dbmax);
//     amap["maxReactivePower"]          = vm.linkVal(vmap, link, "maxReactivePower",              dbmax);
//     amap["ReactivePowerCmd"]          = vm.linkVal(vmap, link, "ReactivePowerCmd",              dval);
//     amap["ActivePowerCmd"]            = vm.linkVal(vmap, link, "ActivePowerCmd",                dbval);
//     amap["HeartBeat"]                 = vm.linkVal(vmap, link, "HeartBeat",                     ival);
...
// // TODO test timeout
// template<class T>
// bool valueChanged(assetVar* one, assetVar* theother, assetVar* deadb , T vtype, double timeout)
// {
//     bool resp;
//     T dval;
//     resp = valueChanged(one->getdVal(), theother->getdVal(),deadb->getdVal());
//     if(!resp)
//     {
