...
// Q what if you need different warnings ... urghhh then you need to swap out the whole onSet Limits object.
// We'll have a number of onSet limits tables and just swap those out perhaps.. this means we need to look up the limits for a particular var.
// getLimits for var dc_current in mode grid_form   etc.
// slight variation on this will do 
// named amaps are it though..
///
//                 {"standby":{
