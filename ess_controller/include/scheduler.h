...
class scheduler {
    ...
    void addSaction(varsmap &vmap, const char* amap, const char* func, const char*var, const char* fvar, asset_manager* am, cJSON* cja);
    int setupSchedItemActions(varsmap& vmap, asset_manager*am, const char* uri, const char*name, const char*when, const char *act, cJSON* cja);
    schedItem *setupSchedItem(varsmap& vmap, asset_manager*am, const char* uri, const char*name , const char* id, const char*aname
                       , double refTime, double runTime , double repTime);
    assetVar* setupSchedVar(varsmap& vmap, asset_manager*am, const char* uri, const char*name , const char* id, const char*aname
                       , double refTime, double runTime , double repTime);
    int activateSchedItem(varsmap& vmap, const char*uri, const char* auri, const char* name, const char* cjtmp=nullptr);
