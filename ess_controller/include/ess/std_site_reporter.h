...
const char* std_site_reporter_s = R"JSON(
{
    ...
    "/controls/site": {
        "site_controller_heartbeat"   : {"value": 0, "enable": "/config/ess:site_control_enable", "actions": {"onSet": [{"remap":[{"ifChanged": false, "uri": "/controls/ess:SiteControllerHeartbeat"     }]}]}},
    ...
    "/vlinks/ess": {
        ...
        "bess_fire_fault"          : {"value": "/status/site:bess_fire_fault"          , "vlink": "/status/ess:"                    },
        "bess_door_alarm"          : {"value": "/status/site:bess_door_alarm"          , "vlink": "/status/ess:"                    },
        ...
        "bms_dc_contactor_control_feedback" : {"value": "/status/site:bms_dc_contactor_control_feedback" , "vlink": "/status/bms:"                    },
