...
struct AssetVarInfo
{
    ...
    AssetVarInfo(const char* u, const char* vn, assetVar::ATypes t) : uri(u), varName(vn), type(t) {}
...
const std::unordered_map<std::string, assetVar::ATypes> paramToDataTypeDict = {
    ...
    { "rampStartDeltaVoltage", assetVar::ATypes::AFLOAT },
...
varmap& PopulateAmapWithManyAvs(varsmap& vmap, varmap& amap, VarMapUtils* vm,
                                std::vector<AssetVarInfo>& assetVarVector);
