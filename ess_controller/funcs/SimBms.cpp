...
// set /ess/components/pcs_registers_fast {"current_status":2}    2021-07-06
// 08:48:15.991769 set /ess/components/catl_bms_ems_r     {"bms_status":1}
// 2021-07-06 08:48:15.994855 set /ess/components/catl_bms_ems_r
// {"bms_poweron":0}       2021-07-06 08:48:15.997846 set
// /components/catl_ems_bms_rw       {"ems_cmd":{"value":2}} 2021-07-06
// 08:48:17.101748 set /ess/components/catl_bms_ems_r     {"bms_poweron":1}
// 2021-07-06 08:48:18.7299

// set /components/catl_ems_bms_rw        {"ems_cmd":{"value":1}} 2021-07-06
// 08:48:20.201921 set /components/catl_ems_bms_rw
// {"ems_cmd":{"value":2}} 2021-07-06 08:48:21.201561 set
// /components/catl_ems_bms_rw        {"ems_cmd":{"value":1}} 2021-07-06
// 08:48:24.102077 set /components/catl_ems_bms_rw
// {"ems_cmd":{"value":2}} 2021-07-06 08:48:25.201726 set
// /components/catl_ems_bms_rw        {"ems_cmd":{"value":1}} 2021-07-06
// 08:48:28.102130

// set /ess/components/pcs_registers_fast {"current_status":3}    2021-07-06
// 08:48:28.18239

// set /components/catl_ems_bms_rw        {"ems_cmd":{"value":2}} 2021-07-06
// 08:48:29.201626

// set /ess/components/pcs_registers_fast {"current_status":18}   2021-07-06
// 08:48:29.22987

// set /components/catl_ems_bms_rw        {"ems_cmd":{"value":1}} 2021-07-06
// 08:48:32.201679 set /components/catl_ems_bms_rw
// {"ems_cmd":{"value":2}} 2021-07-06 08:48:33.101942 set
// /ess/components/pcs_registers_fast {"current_status":3}    2021-07-06
// 08:48:34.27697

// set /components/catl_ems_bms_rw        {"ems_cmd":{"value":1}} 2021-07-06
// 08:48:36.101799

// set /ess/components/pcs_registers_fast  {"current_status":4}   2021-07-06
// 08:48:37.33031 set /ess/components/pcs_registers_fast  {"current_status":6}
// 2021-07-06 08:48:42.37560

// ./fims_send -m set -r /me -u /ess/assets/pcs/summary/start false
// ./fims_send -m set -r /me -u /ess/assets/bms/summary/start false
// ./fims_send -m set -r /me -u /ess/components/pcs_registers_fast/vdc_bus_1
// 1400
// ./fims_send -m set -r /me -u /ess/status/bms/BMSCurrent 0
// # ./fims_send -m set -r /me -u /ess/components/pcsm_dc_inputs/vdc_bus_1
// '{"value":1300}'

// echo "PCS Off, BMS Off, Batteries normal"
// ./fims_send -m set -r /me -u /ess/components/pcs_registers_fast
// '{"current_status":2}'                 # PCS is ready
// ./fims_send -m set -r /me -u /ess/components/catl_bms_ems_r
// '{"bms_status":1}' # BMS is powered off batteries normal
// ./fims_send -m set -r /me -u /ess/components/catl_bms_ems_r
// '{"bms_poweron":0}'
...
// echo "BMS Turning On"
// ./fims_send -m set -r /me -u /ess/components/catl_bms_ems_r
// '{"bms_poweron":1}' echo "Waiting 5 seconds" sleep 5 echo "PCS Start command"
// ./fims_send -m set -r /me -u /ess/components/pcs_registers_fast
// '{"current_status":4}'
...
// # ./fims_send -m set -r /me -u /ess/components/pcs_registers_fast
// '{"current_status":3}' # sleep 5

// # echo "PCS going to ready"
// # ./fims_send -m set -r /me -u /ess/components/pcs_registers_fast
// '{"current_stat us":4}' # echo "PCS Start command" # ./fims_send -m set -r
// /me -u /ess/assets/pcs/summary/start true # echo "Waiting 10 seconds" # sleep
// 10 echo "PCS Turning On"
// ./fims_send -m set -r /me -u /ess/components/pcs_registers_fast
// '{"current_status
// ":6}'                 # PCS is On
// sleep 3
// # ./fims_send -m set -r /me -u
// /ess/components/catl_mbmu_summary_r/mbmu_min_cell_ voltage 2.4 # ./fims_send
// -m set -r /me -u /ess/components/gpio/EStop true
...
// sleep 5
// # ./fims_send -m set -r /me -u /ess/components/pcs_registers_fast
// '{"current_stat us":9}' # echo "Waiting 5 seconds" # sleep 5 # ./fims_send -m
// set -r /me -u /ess/components/catl_bms_ems_r '{"bms_poweron":0}'
...
// # ./fims_send -m set -r /me -u /ess/components/pcs_registers_fast
// '{"current_stat us":4}' # echo "BMS Stop Command in 5 seconds" # ./fims_send
// -m set -r /me -u /ess/assets/bms/summary/stop false # sleep 5 # ./fims_send
// -m set -r /me -u /ess/assets/bms/summary/stop true # echo "Waiting 10
// seconds" # sleep 10 # echo "BMS Turning Off" # ./fims_send -m set -r /me -u
// /ess/components/catl_bms_ems_r '{"bms_poweron":0}'
//                  # BMS is Off

// # ./fims_send -m set -r /me -u /ess/assets/bms/summary/start false
// # echo "PCS Off, BMS Off, Batteries normal"
// # ./fims_send -m set -r /me -u /ess/components/pcs_registers_fast
// '{"current_status":2}' && ./fims_send -m set -r /me -u
// /ess/components/catl_bms_ems_r '{"bms_status":1}' && ./fims_send -m set -r
// /me -u /ess/components/catl_bms_ems_r '{"bms_poweron":0}'

// Method:  set
// Uri:     /components/pcs_registers_fast
// ReplyTo: (null)
// Body:
// {"drop_grad_p_enable":{"value":1},"start_grad_p_enable":{"value":1},"start_grad_q_enable":{"value":1},"stop_grad_p_enable":{"value":1},"stop_grad_q_enable":{"value":1}}
...
// given a desired overall discharge power we'll adjust the bms_ohms and then
// perform the soc change if this is an estimate run then the soc is ignored if
// this is the real run then the bms_soc is adjusted
...
int SimHandleBmsDischarge(varsmap& vmap, varmap& amap, const char* aname, fims* p_fims, assetVar* aV)
{
    ...
    // double  bms_discharge_current      =
    // amap["bms_discharge_current"]->getdVal();
    ...
    if (bms_soc > 0.01)
    {
        if (discharge_current > 300.0)
        {
            dval = 280.0;
            FPS_ERROR_FMT(
                "\n{} bms_ohms error {:2.3f}; limiting discharge current "
                "from {:2.3f} to {:2.3f}\n",
                __func__, bms_ohms, discharge_current, dval);
    ...
    {
        FPS_ERROR_FMT(
            "{} >> {} volts {:2.3f} ohms {:2.3f} dc {:2.3f} dp {:2.3f} "
            "bms_soc {:2.3f}\n",
            __func__, aname, bms_volts, bms_ohms, discharge_current, discharge_power, bms_soc);
    }
    FPS_ERROR_FMT(
        "{} >> {} bms_dp_cmd {:2.3f} bms_dp {:2.3f} dp {:2.3f} bms_soc "
        "{:2.3f} test {}\n",
        __func__, aname, bms_discharge_power_cmd, bms_discharge_power, discharge_power, bms_soc, discharge_test);
...
int SimHandleBmsRack(varsmap& vmap, varmap& amap, const char* aname, fims* p_fims, assetVar* aV)
{
    ...
    if (reload < 2)
    {
        ...
        // double pcs_power_increase_slope  =
        // amap["pcs_power_increase_slope"]->getdVal(); double
        // pcs_power_decrease_slope  = amap["pcs_power_decrease_slope"]->getdVal();
        ...
        // double pcs_loss             = amap["pcs_loss"]->getdVal(); // in % ie 5
        // or 6 % double pcs_current          = amap["pcs_current"]->getdVal();
        ...
        // amap["pcs_power_increase_slope"] = vm->setLinkVal(vmap, "pcs",
        // "/configsim", "pcs_power_increase_slope", dval);
        // amap["pcs_power_decrease_slope"] = vm->setLinkVal(vmap, "pcs",
        // "/configsim", "pcs_power_decrease_slope", dval);
        ...
        // amap["bms_discharge_power"]    = vm->setLinkVal(vmap, aname,
        // "/configsim",    "bms_discharge_power", dval);
    ...
    if (module_enabled)
    {
        ...
        // // TODO cause module_cool to increase as module temp increases up to a
        // maximum if(module_temp > (pcs_temp+60))
        // {
        //     module_cool *= 1.1;
    ...
    if (showMod)
        FPS_ERROR_FMT(
            ...
            " \n",
            __func__, aname, am->name, amap["module_enabled"]->getfName(), module_enabled
            // , module_output_power
            // , pcs_output_power
        );
...
// uses num_modules ( mappes to num_hv_systems) to set up the amaps and assets
// for Pcs modules
int SimSetupBmsRacks(varsmap& vmap, varmap& amap, const char* aname, fims* p_fims, assetVar* aV, const char* modfmt)
{
    // const auto now = flex::get_time_dbl();
    ...
    while (idx <= num_racks)
    {
        ...
        if (1)
            FPS_ERROR_FMT("{} >> >> seeking  [{}] ami {}\n", __func__, mname, static_cast<void*>(ami));
        idx++;
        if (!ami)
        {
            if (1)
                FPS_ERROR_FMT("{} >> >> creating instance [{}] for am [{}]\n", __func__, mname, am->name);
...
// if current_status == 3 (precharge) and i_dc_volts < v_dc_volts &&
// contact_closed = false then increase dc_volts by dc_charge slope If we are
// ready close contactors if needed if we have a charge / discharge request then
// ste PCS power accordingly. For now Max Charge/Discharge is 350000 W
...
// we are asked for a given current we provide that but our internal is
// 100+loss/100 current if SOC > min_soc we provide the power
...
// if current_status == 3 (precharge) and i_dc_volts < v_dc_volts &&
// contact_closed = false then increase dc_volts by dc_charge slope
...
// int SimHandlePcsPrecharge(varsmap& vmap, varmap& amap, const char* xaname,
...
int SimHandleBmsCmd(varsmap& vmap, varmap& amap, const char* xaname, fims* p_fims, assetVar* aV)
{
    ...
    if (!start_seen && (BMSStartKeyCmd == 1))
    {
        ...
        if (debug)
            FPS_ERROR_FMT("{} >> [{:2.3f}] >> Running StartKeyCmd set\n", __func__, now.count());
    }
    ...
    if (!stop_seen && (BMSStopKeyCmd == 1))
    {
        ...
        amap["current_cmd"]->setVal(ival);
        if (debug)
            FPS_ERROR_FMT("{} >> [{:2.3f}] >> Running StopKeyCmd set\n", __func__, now.count());
    }
    if (BMSStartKeyCmd == 0)
    {
        bval = false;
...
int SimHandleBmsStatus(varsmap& vmap, varmap& amap, const char* xaname, fims* p_fims, assetVar* aV)
{
    ...
    //              ,__func__, tNow);
    //         //current_status = 4;// Ready    // we are now ready  we can accept
    //         charge / discharge
    //     }
    // }
    ...
    //     current_status = 6;// On   // we are now ready  we can accept charge /
    //     discharge
    // }
    // if(current_status == 6)
    // {
    ...
    //         lastTime = now.count();
    //         amap["lastTime"]->setVal(lastTime);
    //         current_status = 8;// Discharge   // we are now ready  we can
    //         accept charge / discharge
    //     }
    ...
    //              ,__func__, tNow);
    //         //current_status = 2;// Stop but we need to charge     // we are
    //         now ready  we can accept charge / discharge
    //     }
    // }
    amap["current_status"]->setVal(current_status);
    return 0;
...
int SimHandleBms(varsmap& vmap, varmap& amap, const char* xaname, fims* p_fims, assetVar* aV)
{
    ...
    int ival = 0;
    if (debug)
        FPS_ERROR_FMT(" {} >> running at time {:2.3f} \n", __func__, tNow);
    asset_manager* am = aV->am;
    VarMapUtils* vm = am->vm;
    ...
    if (!am)
    {
        ...
        if (debug)
            FPS_ERROR_FMT(" {} >> adding bms asset manager \n", __func__);
    ...
    if (!am->vm)
    {
        FPS_ERROR_FMT(" {} >> unable to find pcs Varmap(am)  handler vm {} aV->am->vm {}\n", __func__,
                      static_cast<void*>(vm), static_cast<void*>(aV->am->vm));
    ...
    FPS_ERROR_FMT(" {} >> [{:2.3f}] running, aname [{}] am  [{}] var [{}] p_fims {}\n", __func__, now.count(), aname,
                  am->name, aV->getfName(), static_cast<void*>(p_fims));
    ...
    if (reload < 2)
    {
        ...
        //                         {"fims": "set", "uri":
        //                         "/components/pcsm_gradients:drop_grad_p"},
        //                         {"fims": "set", "uri":
        //                         "/components/pcsm_gradients:start_grad_p"},
        //                         {"fims": "set", "uri":
        //                         "/components/pcsm_gradients:stop_grad_p"}
        // {"fims": "set", "uri": "/components/pcsm_gradients:rise_grad_q"},
        //                         {"fims": "set", "uri":
        //                         "/components/pcsm_gradients:drop_grad_q"},
        //                         {"fims": "set", "uri":
        //                         "/components/pcsm_gradients:start_grad_q"},
        //                         {"fims": "set", "uri":
        //                         "/components/pcsm_gradients:stop_grad_q"}
        // {"value": "/assets/pcs/summary:status",
        // "vlink":"/status/pcs:PCSStatusResp"},
        //     //"id": "pcsm_gradients",
        // "/links/pcs":{
        //         "seconds": {             "value":
        //         "/components/pcsm_general:seconds"},

        //"ctrlword2": {             "value": "/components/pcsm_control:ctrlword2" }

        //     "/schedule/wake_monitor/pcs":{
        //         "/components/pcs_registers_fast:vdc_bus_1": { "enable": true,
        //         "rate":1, "amap": "pcs", "func":"CheckMonitorVar"},
        //         "/components/pcsm_general:seconds": { "enable": true, "rate":1,
        //         "func":"CheckMonitorVar"},
        //         "/components/pcs_registers_slow:num_running_modules": { "enable":
        //         true, "rate":1, "func":"CheckMonitorVar"},
        //     },
        amap[fname] = vm->setLinkVal(vmap, aname, "/reload", fname, reload);
        ...
        //        "Timestamp": {        "value":
        //        "/components/pcsm_general:Timestamp"         },
        ...
        //         "Heartbeat": {             "value":
        //         "/components/pcsm_communications:ppc_watchdog_ref"         },
        ...
        // amap["PCSStartKeyCmd"] = vm->setLinkVal(vmap, aname,     "/configsim",
        // "PCSStartKeyCmd", dval); amap["PCSStopKeyCmd"]  = vm->setLinkVal(vmap,
        // aname,     "/configsim", "PCSStopKeyCmd", dval); amap["PCSEStopKeyCmd"] =
        // vm->setLinkVal(vmap, aname,     "/configsim", "PCSEStopKeyCmd", dval);
        // amap["ClearFaultCmd"]  = vm->setLinkVal(vmap, aname,     "/configsim",
        // "ClearFaultCmd", tVal);

        //         "vdc_bus_1": {             "value":
        //         "/components/pcsm_dc_inputs:vdc_bus_1"         },
        amap["vdc_bus_1"] = vm->setLinkVal(vmap, aname, "/configsim", "vdc_bus_1", dval);
        ival = 0;
        // amap["PCSStatusResp"]   = vm->setLinkVal(vmap, aname,    "/configsim",
        // "PCSStatusResp", ival);
        ...
        // amap["MaxPCSActivePower"]   = vm->setLinkVal(vmap, aname,
        // "/configsim", "MaxPCSActivePower", dval); amap["MaxPCSReactivePower"] =
        // vm->setLinkVal(vmap, aname,     "/configsim", "MaxPCSReactivePower",
        // dval); amap["MaxPCSApparentPower"] = vm->setLinkVal(vmap, aname,
        // "/configsim", "MaxPCSApparentPower", dval);

        //"ctrlword_pmode": {             "value":
        //"/components/pcsm_control:p_control_mode"         }, "ctrlword_qmode": {
        //"value": "/components/pcsm_control:q_control_mode"         },
        //"ActivePowerCmd": {             "value":
        //"/components/pcsm_control:p_p_reference"         }, "ActiveCurrentCmd": {
        //"value": "/components/pcsm_control:p_id_reference"         }, "CosPhiCmd":
        //{             "value": "/components/pcsm_control:q_cosphi_reference" },
        //"ReactiveCurrentCmd": {             "value":
        //"/components/pcsm_control:q_iq_reference"         }, "ReactivePowerCmd": {
        //"value": "/components/pcsm_control:q_q_reference"         },
        //"ReactiveVoltageCmd": {             "value":
        //"/components/pcsm_control:q_v_reference"         },
        ...
        //"PStartGradient": {             "value":
        //"/components/pcsm_gradients:start_grad_p"         }, "EnPStartGradient": {
        //"value": "/components/pcsm_gradients:start_grad_p_enable"         },
        //"PStopGradient": {             "value":
        //"/components/pcsm_gradients:stop_grad_p"         }, "EnPStopGradient": {
        //"value": "/components/pcsm_gradients:stop_grad_p_enable"         },
        //"EnPRiseGradient": {             "value":
        //"/components/pcsm_gradients:rise_grad_p_enable"         },
        //"PDropGradient": {             "value":
        //"/components/pcsm_gradients:drop_grad_p"         }, "EnPDropGradient": {
        //"value": "/components/pcsm_gradients:drop_grad_p_enable"         },
        //"QStartGradient": {             "value":
        //"/components/pcsm_gradients:start_grad_q"         }, "EnQStartGradient": {
        //"value": "/components/pcsm_gradients:start_grad_q_enable"         },
        //"QStopGradient": {             "value":
        //"/components/pcsm_gradients:stop_grad_q"         }, "EnQStopGradient": {
        //"value": "/components/pcsm_gradients:stop_grad_q_enable"         },
        //"EnQRiseGradient": {             "value":
        //"/components/pcsm_gradients:rise_grad_q_enable"         },
        //"QDropGradient": {             "value":
        //"/components/pcsm_gradients:drop_grad_q"         }, "EnQDropGradient": {
        //"value": "/components/pcsm_gradients:drop_grad_q_enable"         },
        ...
        // amap["pcs_power_increase_slope"] = vm->setLinkVal(vmap, aname,
        // "/configsim", "pcs_power_increase_slope", dval);
        // amap["pcs_power_decrease_slope"] = vm->setLinkVal(vmap, aname,
        // "/configsim", "pcs_power_decrease_slope", dval);
        amap["bms_current"] = vm->setLinkVal(vmap, aname, "/configsim", "bms_current", dval);
        amap["bms_internal_current"] = vm->setLinkVal(vmap, aname, "/configsim", "bms_internal_current", dval);
        amap["bms_capacity"] = vm->setLinkVal(vmap, aname, "/configsim", "bms_capacity", dval);
        ...
        // char * tval = (char
        // *)"/components/pcs_registers_fast:renamed_current_fault"; this is the
        // local name vm->setVal(vmap, "/links/pcs", "current_fault", tval);
    ...
    //                 91,  (GUNBDC) Mod. Great unbal DC - DC bus unbalanced more
    //                 than 500V"}, 92, (DISFLT) Mod. Discharge fault - Module
    //                 FPGA attempts to discharge the module bus and voltage
    //                           did not drop below 50V in 40s"},
    //                 2,  (HWVBS) HW Vbus - DC overvoltage detected. Threshold:
    //                 1520 Vdc"}, 3, (SFTCHR) Softcharge - Wrong configuration
    //                 (central AC without DU) OR Timeout, one of soft charge
    //                 processes did not end successfully" 4, (DISCHR) Discharge -
    //                 Timeout, one of the modules has not
    ...
    if (1)  // (amap["Heartbeat"]->getLastSetDiff(dval) > 1.0)
    {
        ...
        if (1)
            FPS_ERROR_FMT("{} >> [{:2.3f}] >> Running manager [{}] aname [{}] num_modules {}\n", __func__, dval,
                          am->name, aname, num_racks);
        ...
        for (auto& iy : am->assetMap)
        {
            if (idx < num_racks)
            {
                ...
                aV->am = am;
                if (1)
                    FPS_ERROR_FMT("{} >> Pass 1 {} >>", __func__, ami->name);
        ...
        if (bms_discharge_power_cmd > 0.0)
        {
            ...
            for (auto& iy : am->assetMap)
            {
                asset* ami = iy.second;
                if (1)
                    FPS_ERROR_FMT("{} >> Pass 2 {} test {} >>", __func__, ami->name, bval);
        ...
        if (1)
            FPS_ERROR_FMT("{} >> After loop  [{}] as {} discharge power {} bms_ohms {}\n", __func__,
                          amap["num_running_racks"]->getfName(), ival, dval, bms_ohms);
        // /ess/components/pcs_registers_fast '{"current_status":2}

        // do this until we get the links working
        // vm->sendAssetVar(amap["current_status"], p_fims, "pub",
        // "/components/pcs_registers_fast", "current_status");
        // vm->sendAssetVar(amap["current_fault"], p_fims, "pub",
        // "/components/pcs_registers_fast", "current_fault");
        // vm->sendAssetVar(amap["current_warning"], p_fims, "pub",
        // "/components/pcs_registers_fast", "current_warning");
        ...
        // if(avg_soc > 0)
        // {
        //     vm->setVal(vmap, "/components/catl_mbmu_summary_r", "mbmu_soc",
        //     avg_soc);
        // }
