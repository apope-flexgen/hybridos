...
int SetupBMS(varsmap& vmap, varmap& amap, const char* _aname, fims* p_fims, assetVar* aV)
{
    ...
    // Create vectors for each of the types of stdcfg bms files. v_bms_manager,
    // bms_manager, bms_rack
    ...
    for (int i = 0; i < fileNamesVectorSize; i++)
    {
        ...
        // this section parses the first 3 words in the filename which is how it is
        // determined what config file type it is
