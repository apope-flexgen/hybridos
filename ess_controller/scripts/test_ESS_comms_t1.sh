...
echo -n "setting /config/ess:maxCommsTimeout    " &&$fSend -r /me$$ -m set -u /config/ess '{"maxCommsTimeout": 4.5}'
...
echo -n "getting /status/ess:AllCommsStatus      " &&$fSend -r /me$$ -m get -u /ess/status/ess/AllCommsStatus
echo
sleep 0.2
#exit 
