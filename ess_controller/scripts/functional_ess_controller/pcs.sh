...
read -n1 -p "Press any key to continue - 14 - fims_send -m set -r /$$ -u /assets/pcs/summary/start true";echo
...
read -n1 -p "Press any key to continue - 18 - fims_send -m set -r /$$ -u /assets/pcs/summary/standby true";echo

/usr/local/bin/fims_send -m set -r /$$ -u /assets/pcs/summary/standby true

read -n1 -p "Press any key to continue - 19 - fims_send -m set -u /ess/status/pcs/SystemState '{"value": "Standby"}'";echo
