...
# /usr/local/bin/fims_send -m set -r /$$ -u /ess/sched/bms/LocalStartBMS@endTime 1

# read -n1 -p "Press any key to continue - 10";echo

# /usr/local/bin/fims_send -m set -r /$$ -u /ess/sched/bms/LocalStopBMS@endTime 1
...
read -n1 -p "Press any key to continue - 13 - fims_send -m set -r /$$ -u /ess/status/bms/DCClosed false";echo

/usr/local/bin/fims_send -m set -r /$$ -u /ess/status/bms/DCClosed false

read -n1 -p "Press any key to continue - 14 - fims_send -m set -r /$$ -u /assets/bms/summary/close_contactors true";echo

/usr/local/bin/fims_send -m set -r /$$ -u /assets/bms/summary/close_contactors true

read -n1 -p "Press any key to continue - 15 - fims_send -m set -r /$$ -u /ess/status/bms/DCClosed true";echo

/usr/local/bin/fims_send -m set -r /$$ -u /ess/status/bms/DCClosed true

read -n1 -p "Press any key to continue - 16 - fims_send -m set -u /ess/status/pcs/SystemState '{"value": "Running"}'";echo

/usr/local/bin/fims_send -m set -u /ess/status/pcs/SystemState '{"value": "Running"}'

read -n1 -p "Press any key to continue - 17 - fims_send -m set -r /$$ -u /assets/bms/summary/open_contactors true";echo

/usr/local/bin/fims_send -m set -r /$$ -u /assets/bms/summary/open_contactors true

read -n1 -p "Press any key to continue - 18 - fims_send -m set -u /ess/status/bms/DCClosed false";echo
