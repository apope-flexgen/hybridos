...
read -n1 -p "Press any key to continue - 11 - fims_send -m set -r /$$ -u /assets/pcs/summary/start true";echo
...
read -n1 -p "Press any key to continue - 11 - fims_send -m set -r /$$ -u /assets/pcs/summary/stop true";echo

/usr/local/bin/fims_send -m set -r /$$ -u /assets/pcs/summary/stop true

read -n1 -p "Press any key to continue - 16 - fims_send -m set -u /ess/status/pcs/SystemState '{"value": "Stop"}'";echo

/usr/local/bin/fims_send -m set -u /ess/status/pcs/SystemState '{"value": "Stop"}'


read -n1 -p "Press any key to continue - 11 - fims_send -m set -r /$$ -u /assets/pcs/summary/standby true";echo

/usr/local/bin/fims_send -m set -r /$$ -u /assets/pcs/summary/standby true

read -n1 -p "Press any key to continue - 16 - fims_send -m set -u /ess/status/pcs/SystemState '{"value": "Standby"}'";echo

/usr/local/bin/fims_send -m set -u /ess/status/pcs/SystemState '{"value": "Standby"}'
