...
#            "outValue", &cjov);
# 
/usr/local/bin/fims_send -m set -r /$$ -u /ess/test/ess '
{
    "test_bitset_1":{ 
        "value":false,
        "debug":1,
...
resp=`/usr/local/bin/fims_send -m get -r /$$ -u /ess/full/test/ess/test_bitset_1`
...
resp=`/usr/local/bin/fims_send -m get -r /$$ -u /ess/full/test/ess/test_bitset_2`
check_resp "setup action 2" $resp $exp_resp

/usr/local/bin/fims_send -m set  -u /ess/test/ess '{ "test_bitset_1":{ "value":true}}'
resp=`/usr/local/bin/fims_send -m get -r /$$ -u /ess/full/controls/pcs_test/ctrlword_qmode`
exp_resp='{"ctrlword_qmode":{"value":1}}'
check_resp "send value 1 true" $resp $exp_resp

/usr/local/bin/fims_send -m set  -u /ess/test/ess '{ "test_bitset_1":{ "value":false}}'
resp=`/usr/local/bin/fims_send -m get -r /$$ -u /ess/full/controls/pcs_test/ctrlword_qmode`
exp_resp='{"ctrlword_qmode":{"value":0}}'
check_resp "send value 1 false" $resp $exp_resp

/usr/local/bin/fims_send -m set  -u /ess/test/ess '{ "test_bitset_2":{ "value":true}}'
resp=`/usr/local/bin/fims_send -m get -r /$$ -u /ess/full/controls/pcs_test/ctrlword_qmode`
exp_resp='{"ctrlword_qmode":{"value":2}}'
check_resp "send value 2 true" $resp $exp_resp

/usr/local/bin/fims_send -m set  -u /ess/test/ess '{ "test_bitset_2":{ "value":false}}'
resp=`/usr/local/bin/fims_send -m get -r /$$ -u /ess/full/controls/pcs_test/ctrlword_qmode`
exp_resp='{"ctrlword_qmode":{"value":0}}'
