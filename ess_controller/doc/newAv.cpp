...
public:
    ...
    void show();  // { cout << parent->getName()<< "["<< name << "] type :" <<
                  // atype << " int :" <<valueint << " dbl :"<< valuedouble<<endl;
                  // }
};
...
void AssetParam::show()
{
    cout << parent->getName() << "[" << name << "] type :" << atype << " int :" << valueint << " dbl :" << valuedouble
         << endl;
}
