...
int SetupDefaultSched(scheduler*sched, asset_manager* am)
{
    ...
    am->vm->setFunc(*am->vmap, "ess", "CheckMonitorVar",
(void*)&CheckMonitorVar); am->vm->setFunc(*am->vmap, "ess", "EssSystemInit",
(void*)&EssSystemInit); am->vm->setFunc(*am->vmap, "ess", "Every1000mS",
(void*)&Every1000mS); am->vm->setFunc(*am->vmap, "ess", "Every100mSP1",
(void*)&Every100mSP1); am->vm->setFunc(*am->vmap, "ess", "Every100mSP2",
(void*)&Every100mSP2); am->vm->setFunc(*am->vmap, "ess", "Every100mSP3",
(void*)&Every100mSP3); am->vm->setFunc(*am->vmap, "ess", "FastPub",
(void*)&FastPub); am->vm->setFunc(*am->vmap, "ess", "SlowPub",
(void*)&SlowPub);

    sched->setupSchedVar(*am->vmap, am, "/sched/ess", "essSystemInit",
"EssSystemInit", "ess", 0.200, 0.200 , 0.000); sched->setupSchedVar(*am->vmap,
am, "/sched/ess", "every1000mS" ,  "EverySecond",   "ess", 0.250, 0.250
, 1.000); sched->setupSchedVar(*am->vmap, am, "/sched/ess", "every100mSP1" ,
"Every100mS_P1", "ess", 0.251, 0.251 , 0.100); sched->setupSchedVar(*am->vmap,
am, "/sched/ess", "every100mSP2" , "Every100mS_P2", "ess", 0.252, 0.252 ,
0.100); sched->setupSchedVar(*am->vmap, am, "/sched/ess", "every100mSP3" ,
"Every100mS_P3", "ess", 0.253, 0.253 , 0.100); sched->setupSchedVar(*am->vmap,
am, "/sched/ess", "fastPub" ,      "FastPub",       "ess", 0.254, 0.254 ,
0.050); sched->setupSchedVar(*am->vmap, am, "/sched/ess", "slowPub" ,
"SlowPub",       "ess", 0.255, 0.255 , 2.000);

    cJSON* cja;

    cja = cJSON_CreateArray(); sched->addSaction(*am->vmap, "ess",
"EssSystemInit", "/status/ess:status",   am, cja);
    sched->setupSchedItemActions(*am->vmap, am, "/sched/ess", "essSystemInit",
"onSet", "func", cja); cJSON_Delete(cja);

    cja = cJSON_CreateArray(); sched->addSaction(*am->vmap, "ess",
"Every1000mS", "/status/ess:status",   am, cja);
    sched->setupSchedItemActions(*am->vmap, am, "/sched/ess", "every1000mS",
"onSet", "func", cja); cJSON_Delete(cja);

    cja = cJSON_CreateArray(); sched->addSaction(*am->vmap, "ess",
"Every100mS_P1", "/status/ess:status",   am, cja);
    sched->setupSchedItemActions(*am->vmap, am, "/sched/ess", "every100mSP1",
"onSet", "func", cja); cJSON_Delete(cja);

    cja = cJSON_CreateArray(); sched->addSaction(*am->vmap, "ess",
"Every100mS_P2", "/status/ess:status",   am, cja);
    sched->setupSchedItemActions(*am->vmap, am, "/sched/ess", "every100mSP2",
"onSet", "func", cja); cJSON_Delete(cja);

    cja = cJSON_CreateArray(); sched->addSaction(*am->vmap, "ess",
"Every100mS_P3", "/status/ess:status",   am, cja);
    sched->setupSchedItemActions(*am->vmap, am, "/sched/ess", "every100mSP3",
"onSet", "func", cja); cJSON_Delete(cja);

    cja = cJSON_CreateArray(); sched->addSaction(*am->vmap, "ess", "FastPub",
"/status/ess:status",   am, cja); sched->setupSchedItemActions(*am->vmap, am,
"/sched/ess", "fastPub", "onSet", "func", cja); cJSON_Delete(cja);

    cja = cJSON_CreateArray(); sched->addSaction(*am->vmap, "ess", "SlowPub",
"/status/ess:status",   am, cja); sched->setupSchedItemActions(*am->vmap, am,
"/sched/ess", "slowPub", "onSet", "func", cja); cJSON_Delete(cja);

    // this makes /schedule/ess:add_item activate a schedule item when it is
sent some details sched->setupSchedFunction(*am->vmap, "/schedule/ess",
"add_item", "AddSchedItem", am);


    // now use it to create the sched items and activate the schedule vars
    sched->activateSchedItem(*am->vmap, "/schedule/ess", "/sched/ess",
"essSystemInit"); sched->activateSchedItem(*am->vmap, "/schedule/ess",
"/sched/ess", "every1000mS"); sched->activateSchedItem(*am->vmap,
"/schedule/ess", "/sched/ess", "every100mSP1");
    sched->activateSchedItem(*am->vmap, "/schedule/ess", "/sched/ess",
"every100mSP3"); sched->activateSchedItem(*am->vmap, "/schedule/ess",
"/sched/ess", "every100mSP3"); sched->activateSchedItem(*am->vmap,
"/schedule/ess", "/sched/ess", "fastPub"); sched->activateSchedItem(*am->vmap,
"/schedule/ess", "/sched/ess", "slowPub"); return 0;
}
...
/sched/ess: {
        "essSystemInit":	{
                "value:0,"id":	"EssSystemInit", "aname":"ess",
"enabled":true,"refTime":0.2,"runTime":0.2, "repTime":0, "actions":{"onSet":
[{"func":[
            {"amap":	"ess","func":	"EssSystemInit","var":
"/status/ess:status"}
            ]}]}},
        "every1000mS":	{
                "value":0,"id":
"EverySecond","aname":"ess","enabled":true,"refTime":	0.25,"runTime":
0.25,"repTime":	1, "actions":{"onSet":	[{"func":	[
            {"amap":	"ess","func":	"Every1000mS","var":
"/status/ess:status"}
            ]}}}},
        "every100mSP1":	{
                "value":0,"id":
"Every100mS_P1","aname":"ess","enabled":true,"refTime":
0.251,"runTime":0.251,"repTime":0.1, "actions":{"onSet":	[{"func":
[
            {"amap":	"ess","func":	"Every100mS_P1","var":
"/status/ess:status"}
            ]}}}},
        "every100mSP2":	{
                "value":0,"id":
"Every100mS_P2","aname":"ess","enabled":true,"refTime":
0.252,"runTime":0.252,"repTime":0.1, "actions":{"onSet":	[{"func":
[
            {"amap":	"ess","func":	"Every100mS_P2","var":
"/status/ess:status"}
            ]}}}},
        "every100mSP3":	{
                "value":0,"id":
"Every100mS_P3","aname":"ess","enabled":true,"refTime":
0.253,"runTime":0.253,"repTime":0.1, "actions":{"onSet":	[{"func":
[
            {"amap":	"ess","func":	"Every100mS_P3","var":
"/status/ess:status"}
            ]}}}},
        "fastPub":	{
                "value":0,"id":
"FastPub","aname":"ess","enabled":true,"refTime":
0.254,"runTime":0.254,"repTime":0.05, "actions":{"onSet":	[{"func":
[
            {"amap":	"ess","func":	"FastPub","var":
"/status/ess:status"}
            ]}}}},
        "slowPub":	{
                "value":0,"id":
"SlowPub","aname":"ess","enabled":true,"refTime":
0.255,"runTime":0.255,"repTime":2, "actions":{"onSet":	[{"func":	[
            {"amap":	"ess","func":	"SastPub","var":
"/status/ess:status"}
            ]}}}}
    }
 /schedule/ess:{
...
*
* set /sched/ess:essStateCheck  '{"value":true,"refTime":0.253,
"runTime": 1.25,"repTime":0.5,"var":/status/ess:poweron","function":"CheckEssStatus"}
*
* then flag the variable for the scheduler.
* set /scheduler/ess:add_item  '{"value":/status/ess:essStateCheck"}
* the add_item call will cause the function "CheckEssStatus" to be scheduled at
a time greater than tNow plus 1.25 seconds calcuated from refTime + repTime * n.
*   for example
*   set this value in place /sched/ess:essStateCheck  '{"value":true,
"runTime": 1.25,"repTime":0.0,"var":/status/ess:poweron","function":"CheckEssStatus"}
*   then call
*                set /scheduler/ess:add_item
'{"value":/status/ess:essStateCheck"}
*          at time 25.3 seconds
* the function CheckEssStatus using /status/ess:poweron will be run once at tNow
+ 1.25 seconds (26.58 SECS).
*
*   set this value in place /sched/ess:essPowerCheck  '{"value":true,
"refTime":0.51,
"runTime": 1.25,"repTime":0.5,"var":/status/ess:poweron","function":"CheckEssStatus"}
*   then call
*                set /scheduler/ess:add_item
...
*        the function CheckEssStatus using /status/ess:poweron will be run every
0.5 seconds  starting  at 31.51 Seconds
*
* the repeating function can be stopped immediately be setting the enabled Param
false. and also setting the repTime to 0.0
* nah we can do better than that.
*
*                set /scheduler/ess:add_item
'{"value":/status/ess:essStateCheck", "runTime":1.5, "repTime":0}
*                means
*                       run once in 1.5 seconds
*                set /scheduler/ess:add_item
'{"value":/status/ess:essStateCheck", "runTime":1.5, "repTime":0.1}
...
{
    FPS_ERROR_PRINT(
        " sched id [%8s] count [%4d] aname [%8s] uri [%s:%s] refTime "
        "%2.3f runTime %2.6f repTime %2.3f \n",
        id, runCnt, aname, comp, name ? name : "", refTime, runTime, repTime);
}
...
// "add_sched_item",am)  setupSchedFinction
int scheduler::setupSchedFunction(varsmap& vmap, const char* uri, const char* oper, const char* func, asset_manager* am)
// int setup_sched_function(varsmap& vmap, const char* uri, const char* oper,
// const char*func, asset_manager* am)
{
    char* rbuf;
    ...
    asprintf(&rbuf,
             ...
             "{\"%s\":{\"value\":\"test "
             "string\",\"actions\":{\"onSet\":[{\"func\":[{\"func\":\"%s\","
             "\"amap\":\"ess\"}]}]}}}}",
             uri, oper, func);
...
// this takes the assetVar and  creates the assetSched item and triggers the
// channel write things like repTime and runTime are left in place as params and
// used in the sched list int  add_sched_item(varsmap &vmap, varmap &amap, const
...
//     FPS_ERROR_PRINT("\n\n***** %s >> running for  av [%s:%s] am %p cj %p  aV
//     [%s] value [%s]\n\n"
//         , __func__
//         , av->comp.c_str()
//         , av->name.c_str()
...
//         // this dummy function will simply send the current time to avi
//         triggering its onSet actions
//         // infact we'll do this anyway without a function
//         as->setUp(myid, am->name.c_str(), avi->comp.c_str(),
//         avi->name.c_str(),
//         avi->getdParam("runTime"),avi->getdParam("repTime") );

//         as->show();
//     //TODO phase out the function here... just send the time to the scheduled
//     assetVar
...
//         if (am->reqChan)
//         {
//             channel <schedItem*>* reqChan = (channel
//             <schedItem*>*)am->reqChan; reqChan->put(as);
//         }
//         if (am->wakeChan)
//         {
...
//         else
//         {
//             FPS_ERROR_PRINT(" @@@@@ %s >> You need to set up am->reqChan and
//             am->wakeChan   @@@@\n"
//                 , __func__
//                 );

//         }
//         //TODO let these rip if (am->wakeChan)am->wakeChan->put((int)(tNow *
//         1000));
//         //am->wakeUpChan->put(0)
//         //am->wake_up
...
int scheduler::addSchedItem(varsmap& vmap, varmap& amap, const char* aname, assetVar* av)
{
    ...
    FPS_ERROR_PRINT(
        "\n\n***** %s >> running for  av [%s:%s] am %p cj %p  aV "
        "[%s] value [%s]\n\n",
        __func__, av->comp.c_str(), av->name.c_str(), am,
        cj  // av->getcParam("function")
        ,
        aV ? aV : "NoAv Here", av->getcVal() ? av->getcVal() : " No string val");
    if (cj)
        cJSON_Delete(cj);
    ...
    if (avi && am)
    {
        ...
        if (!myid)
            myid = (char*)"noId";
        si->setUp(myid, avi->name.c_str(), my.Uri, my.Var, avi->getdParam("refTime"), avi->getdParam("runTime"),
                  avi->getdParam("repTime"));

        reqChan.put(si);
        wakeChan.put((int)(tNow * 1000));
        // am->wakeUpChan->put(0)
        // am->wake_up
        FPS_ERROR_PRINT("@@@@@@ %s>> activated %s  id %s  avi %p runTime %2.3f \n\n", __func__, aV, myid, avi,
                        avi->getdParam("runTime"));
        avi->setParam("active", true);
    }
    return 0;
...
//    "actions":{"onSet":[{"func":[{"amap": "ess","func":
...
//    cJSON_Delete(cja);
void scheduler::addSaction(varsmap& vmap, const char* amap, const char* func, const char* var, asset_manager* am,
                           cJSON* cjacts)
{
    cJSON* cj = cJSON_CreateObject();
                                     ...
                                     const char* when, const char* act, cJSON* cjacts)
{
    ...
    fims_message* msg = am->vm->bufferToFims((const char*)rbuf);
    {
        ...
        {
            FPS_ERROR_PRINT(
                "fims  \n nfrags %d   , fims pfrags [1] [%s] fims method "
                "[%s] body [%s]\n",
                msg->nfrags, msg->nfrags > 0 ? msg->pfrags[1] : "no pfrags", msg->method ? msg->method : "no method",
                msg->body ? msg->body : "no body");
        }
        else
        {
...
// set /schedule/ess:name'{"id":"some_id", "aname":"asset_name", "refTime":0.5,
// "runTime":0.5,"repTime":0.1}' we'll have to add actions to this item to make
// it do anything
int scheduler::setupSchedVar(varsmap& vmap, asset_manager* am, const char* uri, const char* name, const char* id,
                             const char* aname, double refTime, double runTime, double repTime)
{
    ...
    asprintf(&rbuf,
             ...
             "\"runTime\":%f,"
             "\"repTime\":%f}}}",
             my.Uri, my.Var, id, aname, refTime, runTime, repTime);
    fims_message* msg = am->vm->bufferToFims((const char*)rbuf);
    if (!msg)
    {
        FPS_ERROR_PRINT(" no message from \n>>>%s<<<\n", rbuf);
...
// "runTime":0.5,"repTime":0.1}' we'll have to add actions to this item to make
// it do anything
schedItem* scheduler::setupSchedItem(varsmap& vmap, asset_manager* am, const char* uri, const char* name,
                                     const char* id, const char* aname, double refTime, double runTime, double repTime)
{
...
//    sends the variable name (/sched/ess:every100ms) for activation to
//    /schedule/ess/add_item which calls the function "add_sched_item" with the
//    value string
// this should be set up beforehand
// sched.setupSchedItem(*am->vmap, am, "/sched/ess", "every100mS" ,
// "Every100mS", "ess", 0.25, 0.25 , 0.1);
    ...
    if (rreqs.size() > 0)
    {
        ...
        while (runit)
        {
            ...
            if (av)
            {
                ...
                {
                    if (0)
                        FPS_ERROR_PRINT("%s >> Running one at %2.6f name [%s:%s]  size %d \n", __func__, tNow,
                                        av->comp.c_str(), av->name.c_str(), (int)rreqs.size());
                    ...
                    if (0)
                        FPS_ERROR_PRINT("%s >> Response %d from %2.6f at %2.6f elapsed mS %2.6f \n", __func__, resched,
                                        tNow, vm->get_time_dbl(), (vm->get_time_dbl() - tNow) * 1000.0);
                }
                as->runCnt++;
                ...
                if (0)
                    FPS_ERROR_PRINT("%s >> new size 1 %d\n", __func__, (int)rreqs.size());
                // could use as->repTime
                if (av->getdParam("repTime") > 0.0)
                {
                    if (0)
                        FPS_ERROR_PRINT(" added av [%s:%s] at %2.6f \n", av->comp.c_str(), av->name.c_str(),
...
int scheduler::fimsDebug1(varsmap& vmap, fims_message* msg, asset_manager* am)
{
    if (msg)
    {
        ...
        if (1)
            FPS_ERROR_PRINT(
                " %s %2.3f   >>>>BEFORE FIMS MESSAGE  method [%s] "
                "replyto[%s]  uri [%s] msize %f\n",
                __func__, tNow, msg->method, msg->replyto ? msg->replyto : "No Reply", msg->uri, msize);
        // bool bval = false;
...
int scheduler::fimsDebug2(varsmap& vmap, fims_message* msg, asset_manager* am)
{
    ...
    {
        if (0)
            FPS_ERROR_PRINT(" %s >> >>>>>>>>>>>  %2.3f  <<<<AFTER FIMS MESSAGE \n", __func__, vm->get_time_dbl());
...
void fimsThread(scheduler* sc, const char* mysubs[], int sublen)
{
    ...
    while (*sc->run)
    {
        ...
        if (msg)
        {
            ...
            {
                if (1)
                    FPS_ERROR_PRINT("%s >> %2.3f GET uri  [%s]\n", __func__, vm.get_time_dbl(), msg->uri);
            }
            if (*sc->run)
            {
                sc->fimsChan.put(msg);
...
//  "/schedule/ess": {
//        "note": "This sets up the method to add scheduler functions in the
//        system", "add_item": {
//            "value": 0,
//            "actions": {
...
// int setup_sched_function(vmap, "/schedule/ess", "add_item",
// "add_sched_item",am)  setupSchedFinction
// int scheduler::setupSchedFunction(varsmap& vmap, const char* uri, const char*
// oper, const char*func, asset_manager* am)
// // int setup_sched_function(varsmap& vmap, const char* uri, const char* oper,
// const char*func, asset_manager* am)
// {
//     char*rbuf;
...
//        "{\"method\":\"set\",\"uri\":\"%s\",\"body\":"
//        "{\"%s\":{\"value\":\"test
//        string\",\"actions\":{\"onSet\":[{\"func\":[{\"func\":\"%s\",\"amap\":\"ess\"}]}]}}}}",
//        uri, oper, func);
//     fims_message *msg = am->vm->bufferToFims((const char *)rbuf);
//     if(msg)
//     {
//         FPS_ERROR_PRINT("fims  nfrags %d   , fims pfrags [1] [%s] fims method
//         [%s] body [%s]\n"
...
int add_sched_item(varsmap& vmap, varmap& amap, const char* aname, fims* p_fims, assetVar* av)
{
    ...
    if (av->getcVal())
    {
        ...
        FPS_ERROR_PRINT("%s >> string value [%s] runTime %2.3f repTime %2.3f var [%s]\n", __func__, av->getcVal(),
                        av->getdParam("runTime"), av->getdParam("repTime"),
                        av->getcParam("var") ? av->getcParam("var") : "No Var");
    }
    char* aV = nullptr;
    if (cji)
    {
    ...
    if (avi && am)
    {
        ...
        // its onSet actions infact we'll do this anyway without a function we can
        // get the default values or use new ones from the incoming request after we
        // are done we set all the incoming params used to < 0
        ...
        // if we specify a run time in the av data then this in an increment from
        // tNow
        ...
        {
            FPS_ERROR_PRINT(
                " @@@@@ %s >> You need to set up am->reqChan and "
                "am->wakeChan   @@@@\n",
                __func__);
        }
        FPS_ERROR_PRINT("@@@@@@ %s>> activated %s   avi %p runTime %2.3f \n\n", __func__, aV, avi, runTime);
        avi->setParam("active", true);
    }
    else
    {
...
// int  xxadd_sched_item(varsmap &vmap, varmap &amap, const char* aname, fims*
// p_fims, assetVar* av)
// {
//     FPS_ERROR_PRINT("\n\n***** %s >> some function called %s NOW running for
//     av [%s:%s]\n\n"
//         , __func__
//         , __func__
//         , av->comp.c_str()
...
int main_test_new_sched(int argc, char* argv[])
{
    ...
    // schedItem *si = new schedItem();
    // si->setUp("item_id", "item name", "/sched/ess","single0_1",
    // "run_some_func", 0.25, 0.1 ); si->func = vm.getFunc(*am->vmap, "ess",
    // "run_some_func"); si->av = vm.getVar(*am->vmap, "/sched/ess:single0_1",
    // nullptr);
    ...
    schedItem* si = sched.setupSchedItem(*am->vmap, am, "/sched/ess", "single0_1", "Single_Shot", "ess", 0.25, 0.25,
                                         0.0);

    if (si)
        rc = sched.addSchedReq(schreqs, si);
    ...
    // sched.setupSchedItemActions(vmap, am, "/sched/ess", "every1S", "onSet@1",
    // "func", cja);
    sched.setupSchedItemActions(vmap, am, "/sched/ess", "every1S", "onSet", "func", cja);
    cJSON_Delete(cja);
    // this makes /schedule/ess:add_item activate a schedule item when it is sent
    // some details
    ...
    if (si2)
        rc = sched.addSchedReq(schreqs, si2);
    ...
    // setup_sched_function(vmap, "/schedule/ess", "add_item", "add_sched_item",
    // am);

    // //int setup_sched_item(varsmap& vmap, const char*name , const char* id,
    // const char*aname, double runTime , double reptime) FPS_ERROR_PRINT("\n\n
    // running set up sched itemses ...\n");
    // setup_sched_item(vmap,"/schedule/ess","every100mS","ID100mS","ess", 0.5,
    // 0.1); setup_sched_item(vmap,"/schedule/ess","every50mS","ID50mS","ess",
    // 0.5, 0.05); setup_sched_item(vmap,"/schedule/ess","every1S","ID1S","ess",
    // 0.5, 1.0);
    ...
    // // now setting a value to "/schedule/ess:every100mS" shouldtrigger all the
    // checkMonitorVar actions tNow = vm.get_time_dbl();
    ...
    // std::thread
    const char* subs[] = { "/ess", "/control", "/sched" };
    int sublen = sizeof subs / sizeof subs[0];
...
extern "C" {
//  int  run_some_func(varsmap &vmap, varmap &amap, const char* aname, fims*
//  p_fims,assetVar* av); int  add_sched_item(varsmap &vmap, varmap &amap, const
//  char* aname, fims* p_fims,assetVar* av);
int CheckMonitorVar(varsmap& vmap, varmap& amap, const char* aname, fims* p_fims, assetVar* av);
}
...
//                 "repTime":0.1
//                 }'
// int  add_sched_item(varsmap &vmap, varmap &amap, const char* aname, fims*
// p_fims, assetVar* av)
// {
//     cJSON *cj = nullptr; //cJSON_Parse(av->getcVal());
//     cJSON *cji = nullptr;// cJSON_GetObjectItem(cj,"function");
...
int main_test_new_ess(int argc, char* argv[])
{
    ...
    if (0 && syscpVec->size() == 0)
    {
        ...
        // __func__, sname.c_str(), (int)syscVec.size()); sname
        // = "ess"; sname += "/ess_1"; syscVec.push_back(std::ref(sname));
    ...
    if (1)
        FPS_ERROR_PRINT(" %s >> ess_man >> syscVec size [%d]\n", __func__, (int)syscpVec->size());
    if (0)
    {
        vm.syscVec = nullptr;
        vm.clearVmap(vmap);
        ...
        for (auto iy : ixa->second)
        {
            if (iy.second->type == assetVar::ASTRING)
            {
                ...
                if (iy.first == "ess" || iy.first == "bms" || iy.first == "pcs" || iy.first == "site")
                {
                    ...
                    if (1)
                        FPS_ERROR_PRINT(" %s >> syscVec size [%d]\n", __func__, (int)syscVec.size());
                    ...
                    // int ccntam = 0;
                    // TODO vm.getVList(*ess_man->vecs, vmap, ass_man->amap, aname,
                    // "Pubs", ccntam);  FPS_ERROR_PRINT("%s >> setting up a %s manager
    ...
    //     vm.setFunc(*am->vmap, "ess", "run_some_func", (void*)&run_some_func);
    //     vm.setFunc(*am->vmap, "ess", "add_sched_item", (void*)&add_sched_item);
    //     vm.setFunc(*am->vmap, "ess", "CheckMonitorVar",
    ...
    //     //rc = sched.addSchedReq(si);
    //     //FPS_ERROR_PRINT(" add sched Item result 1 %d...\n", rc);
    //     schedItem* si = sched.setupSchedItem(*am->vmap, am, "/sched/ess",
    //     "single0_1" , "Single_Shot", "ess", 0.25, 0.25 , 0.0);

    //     if(si) rc = sched.addSchedReq(schreqs, si);
    //     FPS_ERROR_PRINT(" add sched Item result si %p  2 %d...\n", si,  rc);

    //     schedItem* si2 = nullptr;
    //     sched.setupSchedVar(*am->vmap, am, "/sched/ess", "every1S" ,
    //     "EverySecond", "ess", 0.25, 0.25 , 1.0);
    //     //sched.cja = nullptr;
    //     cJSON* cja = cJSON_CreateArray();
    //     sched.addSaction(vmap, "ess", "CheckMonitorVar", "/status/ess:maxTemp",
    //     am, cja); sched.addSaction(vmap, "ess", "CheckMonitorVar",
    //     "/status/ess:maxVolts",  am, cja); sched.addSaction(vmap, "ess",
    //     "CheckMonitorVar", "/status/ess:maxCurrent",am, cja);
    //     // TODO we are going to have to make this "non destructive"
    //     //sched.setupSchedItemActions(vmap, am, "/sched/ess", "every1S",
    //     "onSet@1", "func", cja); sched.setupSchedItemActions(vmap, am,
    //     "/sched/ess", "every1S", "onSet", "func", cja); cJSON_Delete(cja);
    //     // this makes /schedule/ess:add_item activate a schedule item when it
    //     is sent some details sched.setupSchedFunction(vmap, "/schedule/ess",
    //     "add_item", "add_sched_item", am);

    //     // now use it to create a schedule var
    //     sched.activateSchedItem(vmap, "/schedule/ess", "/sched/ess",
    //     "every100mS"); sched.activateSchedItem(vmap, "/schedule/ess",
    //     "/sched/ess", "every1S");

    // //int activate_sched_item(vmap, "/schedule/ess", "sched/ess", "every100mS")
    //     //int activate_sched_item(vmap, "/schedule/ess", "sched/ess",
    //     "every100mS")

    //     //now writes to this /schedule/ess:add_item will set up a schedule
    //     operation.
    //     // once we have am->writeChan and am->reqChan setup..
