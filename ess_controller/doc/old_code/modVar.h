...
enum Type_of_Register {
    None, Coil, Discrete_Input, Input_Register, Holding_Register, Num_Register_Types
};
...
//int set_register(double temp_reg_val, maps *reg, connection *connection, component *component);
