#!/bin/bash
#"name":"test_subtract.sh",
#"author":"Phil Wilshire",
#"desc":"test the Subtract function",
#"date":"04_19_2023"
...
test()
{
    ...
    expect='{"float_output1":120.44,"float_output2":-1014.1199999999999}'
    get="fims_send -m get -r /$$ -u /some/output"
    runget $expect $get
    ...
    expect='{"float_output1":-19.1,"float_output2":-53.1}'
    get="fims_send -m get -r /$$ -u /some/output"
    runget $expect $get
