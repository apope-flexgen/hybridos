...
test()
{
    ...
    expect='{"bool_output1":false,"bool_output2":false,"int_output1":16,"int_output2":16}'
    get="fims_send -m get -r /$$ -u /some/output"
    runget $expect $get
    ...
    expect='{"bool_output1":true,"bool_output2":true,"int_output1":16,"int_output2":16}'
    get="fims_send -m get -r /$$ -u /some/output"
    runget $expect $get
