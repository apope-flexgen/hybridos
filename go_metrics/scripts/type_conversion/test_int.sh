...
test()
{
    ...
    expect='{"bool_to_int":1,"float_to_int":34,"int_to_int":5,"string_to_int":5,"uint_to_int":6}'
    runget $expect $get
    ...
    usetime 2
    expect='{"bool_to_int":1,"float_to_int":0,"int_to_int":5,"string_to_int":5,"uint_to_int":6}'
    get="fims_send -m get -r /$$ -u /some/output"
    runget $expect $get
