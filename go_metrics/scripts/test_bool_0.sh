...
logname=bool_1
cfgname=examples/type_conversion/bool
timeout=20
timeused=0
...
test()
{
    ...
    usetime 2
    echo ' expect '
    echo '{"bool_to_bool":true,"float_to_bool":true,"int_to_bool":true,"string_to_bool":true,"uint_to_bool":true}'
    ...
    usetime 2
    echo ' expect '
    echo '{"bool_to_bool":false,"float_to_bool":false,"int_to_bool":true,"string_to_bool":true,"uint_to_bool":false}'
    fims_send -m get -r /$$ -u /some/output
    usetime $timeleft
