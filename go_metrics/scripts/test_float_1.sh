...
logname=float_1
cfgname=examples/type_conversion/float
timeout=20
timeused=0
...
test()
{
    ...
    usetime 2
    echo ' expect '
    echo '{"bool_to_float":1,"float_to_float":34.56,"int_to_float":-1,"string_to_float":5,"uint_to_float":1}'
    ...
    usetime 2
    echo ' expect '
    echo '{"bool_to_float":0,"float_to_float":0,"int_to_float":0,"string_to_float":5,"uint_to_float":34}'
    #get  {"bool_to_bool":true,"float_to_bool":true,"int_to_bool":true,"string_to_bool":true,"uint_to_bool":true}
    fims_send -m get -r /$$ -u /some/output
    ...
    usetime 2
    echo ' expect '
    echo '{"bool_to_float":0,"float_to_float":0,"int_to_float":34,"string_to_float":5,"uint_to_float":0}'
    fims_send -m get -r /$$ -u /some/output
    usetime $timeleft
