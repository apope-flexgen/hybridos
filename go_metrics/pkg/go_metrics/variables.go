...
var inputToMetricsExpression map[string]map[int]struct{} // when variables change their values (and only when), we will re-evaluate the corresponding expressions
