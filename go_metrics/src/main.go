...
func main() {
	...
	flag.StringVar(&processName, "name", "go_metrics", "the process name to send as and subscribe to")
	flag.StringVar(&processName, "n", "go_metrics", "the process name to send as and subscribe to")
