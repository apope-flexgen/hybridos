...
int main(const int argc, const char* argv[]) noexcept {
    ...
    if(cmd == "test")
    {
        ...
        std::cout << "test_timer                                                                    : basic timer test using std::list" << std::endl;
        std::cout << "test_timer_set                                                                : basic timer test using std::set " << std::endl;
        ...
        std::cout << "*test_fims  fims pacing test                                                  : set up fims connection then take it dowm"  << std::endl;
        std::cout << "*test_fims_uri  simple fims test                                              : set up fims connection set a few then take it dowm"  << std::endl;
        std::cout << "*test_fims_uri_get  simple fims test                                          : set up fims connection get a few then take it dowm"  << std::endl;
        std::cout << "*test_HB  simple HB test                                                      : create a hb struct  and run it"  << std::endl;
        std::cout << "*test_get_local  simple local get test                                        : get all the local values"  << std::endl;
    ...
    if(cmd == "test_fims_uri")
    {
        ...
        if(debug) std::cout << "test_fims_uri <file>  running :"<< std::endl;
        //return 0;
        // std::map<std::string, std::any> gcom_map;
        ...
        // test_fims_send_uri(myCfg, "set", "/components/comp_sel_2440", "{\"test_id\":{\"value\":1238},\"inv_1_16\":12,\"inv_1_4\":15 }", debug);
        // test_fims_send_uri(myCfg, "set", "/components/comp_sel_2440", "{\"test_id\":{\"value\":1239},\"inv_1_4\":15 }", debug);
        // test_fims_send_uri(myCfg, "set", "/components/comp_sel_2440", "{\"test_id\":{\"value\":1240},\"coil_4\":true }", debug);
        // test_fims_send_uri(myCfg, "set", "/components/comp_sel_2440", "{\"test_id\":{\"value\":1242},\"coil_4\":0,\"coil_5\":1 }", debug);
        // test_fims_send_uri(myCfg, "set", "/components/comp_sel_2440", "{\"test_id\":{\"value\":1243},\"coil_4\":false,\"coil_5\":true }", debug);
        ...
        // test_fims_send_uri(myCfg, "set", "/components/comp_sel_2440", "{\"multi_2\":{\"value\":1243},\"multi_3\":false,\"multi_4\":true }", debug);


        // test_fims_send_uri(myCfg, "set", "/components/comp_sel_2440", "{\"multi_2\":{\"value\":2243},\"multi_3\":{\"value\":3100},\"multi_4\":{\"value\":4100} }", debug);
        // test_fims_send_uri(myCfg, "set", "/components/comp_sel_2440/_disable", "{\"multi_3\":{\"value\":3333} }", debug);
        // test_fims_send_uri(myCfg, "set", "/components/comp_sel_2440", "{\"multi_2\":{\"value\":2244},\"multi_3\":{\"value\":3102},\"multi_4\":{\"value\":4102} }", debug);
        // test_fims_send_uri(myCfg, "set", "/components/comp_sel_2440/_enable", "{\"multi_3\":{\"value\":3444} }", debug);
        // test_fims_send_uri(myCfg, "set", "/components/comp_sel_2440", "{\"multi_2\":{\"value\":2245},\"multi_3\":{\"value\":3103},\"multi_4\":{\"value\":4103} }", debug);
    ...
    if(cmd == "test_fims_uri_get")
    {
        ...
        if(debug) std::cout << "test_fims_uri_get  running :"<< std::endl;
        // std::map<std::string, std::any> gcom_map;
...
// this tests the remote path single set
        test_uri_body(myCfg, "/components/comp_sel_2440/test_id", "set", "gcom_test", "tester_name", nullptr,"{\"value\":10021}");
        // 1503
// this tests the remote path multi set
        test_uri_body(myCfg, "/components/comp_sel_2440", "set", "gcom_test", "tester_name", nullptr,"{\"multi_1\":2021}");
        // 1503 1504
        test_uri_body(myCfg, "/components/comp_sel_2440", "set", "gcom_test", "tester_name", nullptr,"{\"multi_1\":2021,\"multi_2\":2022}");
        // "set"
...
//        test_set_uris(myCfg);
        ...
        myCfg.fims_test.Send( fims::str_view{method , strlen(method)}, fims::str_view{uri, strlen(uri)},fims::str_view{nullptr, 0},
                fims::str_view{"test_uname", sizeof("test_uname") - 1},
                body ? fims::str_view{body, strlen(body)} : fims::str_view{nullptr, 0});
    ...
    if(cmd == "test_HB")
    {
        ...
        for (auto &myhb : myCfg.heartbeat_points)
        {
            ...
            {
                if(gcom_findCompVar(read_point, myCfg, myhb.second->component, myhb.second->component_heartbeat_read_uri))
            ...
            {
                if(gcom_findCompVar(write_point, myCfg, myhb.second->component, myhb.second->component_heartbeat_write_uri))
...
//    threadControl.responseThread.join();
    ...
    if (argc > 3)
    {
        ...
        if(cmd == "test_iopoint_multi")
        {
            ...
            test_io_point_multi(argv[2], atoi(argv[3]), 2, oper, device_id, register_type, offset, value, num_threads, myCfg, debug);
