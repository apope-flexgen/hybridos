...
def after_feature(context, feature):
    subprocess.run(["pkill", "dbi"], stdout=subprocess.PIPE,
                   stderr=subprocess.PIPE, check=False)
    subprocess.run(["pkill", "mongo"], stdout=subprocess.PIPE,
                   stderr=subprocess.PIPE, check=False)
    subprocess.run(["pkill", "gcom_modbus"], stdout=subprocess.PIPE,
                   stderr=subprocess.PIPE, check=False)
