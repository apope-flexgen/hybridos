...
def process_message(message):
    ...
    for message_block in message_blocks:
        ...
        if all((method_match, uri_match, value_match, replyto_match,
                process_name_match, username_match, timestamp_match)):
            ...
            try:
                timestamp = datetime.strptime(
                    timestamp_str, '%Y-%m-%d %H:%M:%S.%f').timestamp()
            except:
...
def process_messages(message_text):
    '''
