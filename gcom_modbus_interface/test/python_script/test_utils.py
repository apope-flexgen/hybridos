...
DOCKER_PYTHON_SCRIPT_DIR = "/home/docker/hybridos/gcom_modbus_interface/test/python_script" # this should be vlinked to the LOCAL_PYTHON_SCRIPT_DIR
LOCAL_PYTHON_SCRIPT_DIR = "C:/flexgen/hybridos/gcom_modbus_interface/test/python_script"
...
EXPECTED_TEST_OUTPUT_DIR = "expected"
TEST_LOG_DIR = "logs"
TEST_OUTPUT_DIR = "actual"
TEST_CONSOLE_OUTPUT_DIR="console"
dirs = [CONFIGS_DIR, TEST_SCRIPT_DIR, EXPECTED_TEST_OUTPUT_DIR, TEST_LOG_DIR, TEST_OUTPUT_DIR, TEST_CONSOLE_OUTPUT_DIR]
...
MAX_FLOAT_32 = 3.4028237 * 10**38
MIN_FLOAT_32 = 1.175494 * 10**-38
