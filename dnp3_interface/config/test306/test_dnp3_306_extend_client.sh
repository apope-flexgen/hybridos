...
fims_send -m set -u /sites/brp_sierra/TESTCROB_DEFAULT  '{"value":"LATCH_OFF"}'
fims_send -m set -u /local_client/full/sites/brp_sierra/TESTCROB_DEFAULT  '{"value":"LATCH_OFF"}'
fims_send -m set -u /local_client/naked/sites/brp_sierra/TESTCROB_DEFAULT  '{"value":"LATCH_OFF"}'
fims_send -m set -u /local_client/naked/sites/brp_sierra/TESTCROB_DEFAULT  '{"value":"LATCH_ON"}'
fims_send -m set -u /local_client/full/sites/brp_sierra/TESTCROB_DEFAULT  '{"value":"LATCH_ON"}'
fims_send -m set -u /local_client/naked/sites/brp_sierra/TESTCROB_DEFAULT  '{"value":"LATCH_ON"}'
fims_send -m set -u /local_client/clothed/sites/brp_sierra/TESTCROB_DEFAULT  '{"value":"LATCH_ON"}'
fims_send -m set -u /local_client/clothed/sites/brp_sierra/TESTCROB_DEFAULT  '{"value":"LATCH_OFF"}'

fims_send -m set -u /sites/brp_sierra/TESTCROB_STRING  '{"value":"LATCH_OFF"}'
fims_send -m set -u /sites/brp_sierra/TESTCROB_STRING  '{"value":"LATCH_ON"}'
fims_send -m set -u /sites/brp_sierra/TESTCROB_STRING  '{"value":"PULSE_OFF"}'
fims_send -m set -u /sites/brp_sierra/TESTCROB_STRING  '{"value":"PULSE_ON"}'
fims_send -m set -u /sites/brp_sierra/TESTCROB_INT  '{"value":"LATCH_OFF"}'
fims_send -m set -u /sites/brp_sierra/TESTCROB_INT  '{"value":"LATCH_ON"}'
fims_send -m set -u /sites/brp_sierra/TESTCROB_INT  '{"value":"PULSE_OFF"}'
fims_send -m set -u /sites/brp_sierra/TESTCROB_INT  '{"value":"PULSE_ON"}'
