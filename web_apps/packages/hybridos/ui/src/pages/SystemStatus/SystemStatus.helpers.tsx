...
const stringToTitleCase = (txt) => txt.charAt(0).toUpperCase() + txt.substring(1).toLowerCase();
export const toTitleCase = (str: string) => str.replace(/\w\S*/g, stringToTitleCase);

export const formatServiceName = (serviceName: string) => toTitleCase(serviceName.replace(/_/g, ' '));
