...
import { durationRowSx, setWidth } from 'src/pages/ActivityLog/AlertManagement/alertManagement.styles';
...
const DurationRow = ({
  ...
  const handleDurationFieldChange = (field: string, newValue: string | number) => {
    ...
    const newExpression: Expression = {
      ...expression,
      duration: expression.duration ? { ...expression.duration, [field]: newValue } : { unit: 'minute', value: '', [field]: newValue },
    };
