...
export const variableOverrideColumns: Column[] = [
  ...
  {
    id: 'current_value', label: 'Current Value', minWidth: 18, accentColor: true,
  },
  {
    id: 'enable', label: 'Enable', minWidth: 19, align: 'center',
  },
  {
    id: 'edit_override', label: 'Edit', minWidth: 10, align: 'right',
  },
...
export const SITE_NAMES_URL = '/variable-override/sites';
export const VARIABLE_NAMES_URL = '/variable-override/variable-names';
export const VARIABLE_VALUES_URL = '/variable-override/variable-values';
export const UPDATE_VARIABLE_OVERRIDE_URL = '/variable-override/override-value';
