export const SiteAdminsDescriptions = {
    ...
    radiusTestResponse: 'A response message describing whether or not the test of radius credentials passed or failed',
    ...
    passExpInt: 'Time until password expires, in format length (numeric) interval (m - minutes, d -days); ex: 8d would mean 8 days',
