...
describe('DashboardsController', () => {
    ...
    describe('test getDashboards', () => {
        it('should return dashboards', async () => {
            jest
                .spyOn(dashboardsService, 'getDashboards')
                .mockResolvedValue(UI_CONFIG_DASH);
    ...
    describe('test postDashboards', () => {
        ...
        it('should return dashboards after post', async () => {
            jest
                ...
                .mockResolvedValue(UI_CONFIG_DASH_AFTER_POST);
            expect(await dashboardsController.postDashboards(POST_DASH)).toMatchObject(UI_CONFIG_DASH_AFTER_POST);
        });
        ...
        it('should throw an exception', async () => {
            ...
            await expect(dashboardsController.postDashboards('bad' as unknown as DashboardCard))
                .rejects.toThrow();
        });
    });
});