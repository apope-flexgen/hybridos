...
export class Info {
    ...
    @IsOptional()
    name?: string
    @ApiProperty({ description: DashboardsDescriptions.sourceURIs, type: String, isArray: true  })
    @IsArray()
    @IsOptional()
    sourceURIs?: string[]
  }
  ...
  export class Dashboard {
    ...
    @IsObject()
    info: Info
    @ApiProperty({ description: DashboardsDescriptions.status, type: Status, isArray: true })
    @IsArray()
    status: Status[]
  }
  
  export class DashboardCard {
    @ApiProperty({ description: DashboardsDescriptions.data, type: Dashboard, isArray: true })
    @IsArray()
    data: Dashboard[]
  }
