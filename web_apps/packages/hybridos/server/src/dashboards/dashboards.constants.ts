export const DashboardsDescriptions = {
  ...
  statusScalar: 'Scalar value to use for this status to display on the dashboard card',
  ...
  infoBatteryView: 'Whether or not to use the battery view in the UI for this dashboard card',
  infoBatteryViewSourceURI: 'Which source URI to pull the battery view information from',
  ...
  items:
    ' Only shows if IsTemplate is turned on, Allows user to define templated items (items with the same statuses)',
