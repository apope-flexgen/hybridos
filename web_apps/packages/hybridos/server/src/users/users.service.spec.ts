...
describe('UsersService', () => {
    ...
    describe('update', () => {
        it('should update user password', async () => {
            ...
            const existingUser = {
                ...
                username: 'flexgen_user',
                role: 'admin',
                password: '$2a$14$KBwbs2KBJSFQA4QIK9ijFOjLTwfm/g0G9QtpfbFA3Fz4JTABSn29a',
            ...
            const updatedRecord = {
                ...
                username: 'flexgen_user',
                role: 'admin',
                password: '$2a$14$iC6uR.AwU2qCE1kc/371ju4ciL34GnfCBe7Nv8fVBxKLMXY8FA8Lu',
                old_passwords: [
                    'hello',
                    '$2a$14$ay.jV2I.9KBMQSWCH9UG9uoAFc3OJTsqdItaABghq7McZaiBpdMJW',
                ],
                shared_key: '',
                mfa_enabled: false,
                version: '',
    ...
    describe('read', () => {
        ...
        it('should fail to read: username not found', async () => {
            ...
            await expect(usersService.readById(TEST_USERNAME)).rejects.toThrow(
                UserNotFoundException
            )
        })
