...
export const UserDescriptions = {
  ...
  old_passwords:
    'List of previous user passwords, used for password expiration (when users password expires and certain password settings are set, they may not use new passwords that are in this list).',
