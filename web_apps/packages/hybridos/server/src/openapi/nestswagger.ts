...
export class NestSwagger {
  ...
  public generateDocumentation(): void {
    ...
    const config = new DocumentBuilder()
      ...
      .addTag(
        'scheduler',
        'Allows users to get, add, delete, and edit Scheduler events and modes, as well as get and edit the Scheduler configuration',
      )
      .addTag(
        'site',
        'Allows users to get, add, delete, and edit Scheduler events and modes, as well as get and edit the Scheduler configuration',
      ...
      .addTag(
        'fims',
        'Allows users to get a fims one-time-auth token, as well as send fims get, post, set, and delete messages',
      )
      .addTag('layouts', 'Allows users to get and edit configured layouts from dbi')
      .addTag(
        'site-admins',
        'Allows users to get and edit site settings (password settings, radius settings), send radius tests',
      )
      .addTag('users', 'Allows users to get, add, edit, read, and delete users')
      .addTag(
        'web-ui-config',
        'Allows users to get the full site configuration data object as well as a subset of config data used on the login page',
      )
