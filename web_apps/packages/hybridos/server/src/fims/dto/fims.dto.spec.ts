...
describe('FimsDTO', () => {
  describe('validate GetDTO', () => {
    ...
    it('validate uri empty', async () => {
      ...
      await target.transform(testObj, metadata).catch((err) => {
        expect(err.getResponse().message).toEqual(['uri should not be empty']);
      });
    });
    ...
    it('validate replyto empty', async () => {
      ...
      await target.transform(testObj, metadata).catch((err) => {
        expect(err.getResponse().message).toEqual(['replyto should not be empty']);
      });
    });
  ...
  describe('validate BodyDTO', () => {
    ...
    it('validate body type', async () => {
      ...
      await target.transform(testObj, metadata).catch((err) => {
        expect(err.getResponse().message).toEqual(['body must be a string']);
      });
    });
  });
  ...
  describe('validate FimsMsgDTO', () => {
    ...
    it('validate method empty', async () => {
      ...
      await target.transform(testObj, metadata).catch((err) => {
        expect(err.getResponse().message).toEqual(['method should not be empty']);
      });
    });
