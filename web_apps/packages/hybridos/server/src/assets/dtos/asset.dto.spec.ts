    ...
    describe('validate Status DTO', () => {
        ...
        it('validate scalar type', async () => {
            ...
            await target.transform(testObj, metadata)
                .catch(err => {
                    expect(err.getResponse().message)
                        .toEqual(["scalar must be a string"])
                });
        });
        ...
        it('validate units type', async () => {
            ...
            await target.transform(testObj, metadata)
                .catch(err => {
                    expect(err.getResponse().message)
                        .toEqual(["units must be a string"])
                });
        });
    ...
    describe('validate Control DTO', () => {
        ...
        it('validate inputType type', async () => {
            ...
            await target.transform(testObj, metadata)
                .catch(err => {
                    expect(err.getResponse().message)
                        .toEqual(["inputType must be a string"])
                });
        });
    ...
    describe('validate Alarm DTO', () => {
        ...
        it('validate alarmFields type', async () => {
            ...
            await target.transform(testObj, metadata)
                .catch(err => {
                    expect(err.getResponse().message)
                        .toEqual(["alarmFields must be an array"])
                });
        });
        ...
        it('validate faultFields type', async () => {
            ...
            await target.transform(testObj, metadata)
                .catch(err => {
                    expect(err.getResponse().message)
                        .toEqual(["faultFields must be an array"])
                });
        });
    ...
    describe('validate Asset DTO', () => {
        ...
        it('validate alarms type', async () => {
            ...
            await target.transform(testObj, metadata)
                .catch(err => {
                    expect(err.getResponse().message)
                        .toEqual(["alarms must be an object"])
                });
        });
        ...
        it('validate controls type', async () => {
            ...
            await target.transform(testObj, metadata)
                .catch(err => {
                    expect(err.getResponse().message)
                        .toEqual(["controls must be an array"])
                });
        });
        ...
        it('validate info type', async () => {
            ...
            await target.transform(testObj, metadata)
                .catch(err => {
                    expect(err.getResponse().message)
                        .toEqual(["info must be an object"])
                });
        });
        ...
        it('validate statuses type', async () => {
            ...
            await target.transform(testObj, metadata)
                .catch(err => {
                    expect(err.getResponse().message)
                        .toEqual(["statuses must be an array"])
                });
        });
        ...
        it('validate summary type', async () => {
            ...
            await target.transform(testObj, metadata)
                .catch(err => {
                    expect(err.getResponse().message)
                        .toEqual(["summary must be an array"])
                });
        });
        ...
        it('validate summaryControls type', async () => {
            ...
            await target.transform(testObj, metadata)
                .catch(err => {
                    expect(err.getResponse().message)
                        .toEqual(["summaryControls must be an array"])
                });
        });
