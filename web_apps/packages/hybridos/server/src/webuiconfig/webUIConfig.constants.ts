export const WebUIConfigDescriptions = {
  ...
  productResponse: 'Product type from site configuration found in web ui config file',
  customer: 'Customer name from site configuration found in web ui config file',
...
export const SiteConfigDescriptions = {
  timezone:
    'The timezone to be utilized by the user interface, used to display the time in the top app bar',
  product:
    'The HybridOS product - a product flag of “SC” or “ESS” will display HybridOS Control and a product flag of “FM” will display HybridOS Coordinate',
  ...
  units:
    'An object containing the units to be used on the Configurable Asset Pages (generic) throughout the UI',
  inspectorComponentsName: '(deprecated)',
  site_name: 'The site name displayed in the Site Status Bar, App Bar, and the login page',
  fleet_name:
    'Used to determine which fleet is using the UI, currently only being used to display the ERCOT Overrides Page (flag must be set to “ERCOT”)',
  ...
  fleet_manager_dashboard:
    'Whether or not to display the Fleet Manager Dashboard page (deprecated)',
  site_status_bar: 'Whether or not to display the Site Status Bar component',
  customer:
    'Object containing information about the customer. Displayed on the login page of the UI.Contains sub fields for customer name and server name.',
};
