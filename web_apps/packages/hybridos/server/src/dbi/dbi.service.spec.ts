...
describe('AssetsService', () => {
    ...
    describe('test getFromDBI', () => {
        it('should use the URI', async () => {
            const getFromDBIService = jest
                .spyOn(fimsService, 'get')
        ...
        it('should throw DBI exception', async () => {
            jest
                .spyOn(fimsService, 'get')
                .mockResolvedValue(FIMS_RESPONSE_ERR);
    ...
    describe('test postToDBI', () => {
        ...
        it('should return DBI body', async () => {
            jest
                .spyOn(fimsService, 'send')
                .mockResolvedValue(FIMS_RESPONSE);
            expect(await dbiService.postToDBI(DBI_DEST_URI, 'example data'))
                .toEqual(FIMS_RESPONSE.body);
        });
    });
});